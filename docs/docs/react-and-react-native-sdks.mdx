...
Now fireback comes with a react.js project on https://github.com/torabian/fireback/tree/main/modules/workspaces/codegen/react-new
...
In a nutshell, in version 1.1.28 content will be generated:
