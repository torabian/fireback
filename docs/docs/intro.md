...
This project is licensed under the [GNU Affero General Public License (AGPL)](https://github.com/torabian/fireback/LICENSE.md). Contributions and modifications must be shared under the same terms. 
