...
import { ChangePasswordActionReqDto } from "../workspaces/WorkspacesActionsDto";
export function usePostPassportChangePassword(props?: UseRemoteQuery) {
  ...
  const url = "/passport/change-password".substr(1);
  ...
  const submit = (
    values: Partial<ChangePasswordActionReqDto>,
