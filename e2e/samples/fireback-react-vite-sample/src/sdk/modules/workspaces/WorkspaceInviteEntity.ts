  ...
  */
  ...
  public static Navigation = {
    edit(uniqueId: string, locale?: string) {
      return `${
        locale ? "/" + locale : ".."
      }/workspace-invite/edit/${uniqueId}`;
    },
  ...
  public static definition = {
    ...
    cliShort: "invite",
    description:
      "Active invitations for non-users or already users to join an specific workspace, created by administration of the workspace",
  };
