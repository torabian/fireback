...
import { EmailSenderEntity } from "./EmailSenderEntity";
import { GsmProviderEntity } from "./GsmProviderEntity";
...
export class NotificationConfigEntity extends BaseEntity {
  ...
  public static Navigation = {
    edit(uniqueId: string, locale?: string) {
      return `${
        locale ? "/" + locale : ".."
      }/notification-config/edit/${uniqueId}`;
    },
  ...
  public static definition = {
    ...
    cliShort: "config",
    description:
      "Configuration for the notifications used in the app, such as default gsm number, email senders, and many more",
  };
