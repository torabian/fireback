...
// Class body
export type PassportMethodEntityKeys = keyof typeof PassportMethodEntity.Fields;
export class PassportMethodEntity extends BaseEntity {
  ...
  */
  ...
  public static definition = {
    ...
    fields: [
      {
        ...
        of: [
          ...
          },
          {
            k: "phone",
            description:
              "Authenticat users using phone number, can be sms, calls, or whatsapp.",
          },
          {
            k: "google",
            description:
              "Users can be authenticated using their google account",
          },
        ],
    ...
    cliShort: "method",
    description:
      "Login/Signup methods which are available in the app for different regions (Email, Phone Number, Google, etc)",
  };
