...
// Class body
export type WorkspaceRoleEntityKeys = keyof typeof WorkspaceRoleEntity.Fields;
export class WorkspaceRoleEntity extends BaseEntity {
  ...
  public static definition = {
    ...
    cliShort: "role",
    description:
      "Manage roles assigned to an specific workspace or created by the workspace itself",
  };
