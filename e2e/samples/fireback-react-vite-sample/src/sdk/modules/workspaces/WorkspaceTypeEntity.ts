...
// Class body
export type WorkspaceTypeEntityKeys = keyof typeof WorkspaceTypeEntity.Fields;
export class WorkspaceTypeEntity extends BaseEntity {
  ...
  */
  ...
  public static definition = {
    ...
    cliName: "type",
    description:
      "Defines a type for workspace, and the role which it can have as a whole. In systems with multiple types of services, e.g. student, teachers, schools this is useful to set those default types and limit the access of the users.",
  };
