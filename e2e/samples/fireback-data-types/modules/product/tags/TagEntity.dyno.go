...
import (
	...
	metas "github.com/torabian/fireback/e2e/samples/fireback-data-types/modules/product/tags/metas"
...
type TagEntityQs struct {
	Name        fireback.QueriableField `cli:"name" table:"tag" typeof:"string" column:"name" qs:"name"`
	Description fireback.QueriableField `cli:"description" table:"tag" typeof:"string?" column:"description" qs:"description"`
	Importance  fireback.QueriableField `cli:"importance" table:"tag" typeof:"float64?" column:"importance" qs:"importance"`
}
...
type TagEntity struct {
	...
	Description      emigo.Nullable[string]  `json:"description" xml:"description" yaml:"description"        `
	Importance       emigo.Nullable[float64] `json:"importance" xml:"importance" yaml:"importance"        `
	Children         []*TagEntity            `csv:"-" gorm:"-" sql:"-" json:"children,omitempty" xml:"children,omitempty"  yaml:"children,omitempty"`
	LinkedTo         *TagEntity              `csv:"-" yaml:"-" gorm:"-" json:"-" sql:"-" xml:"-"`
}
...
var TagActions tagActionsSig = tagActionsSig{
	...
	RemoveEnqueue:  TagActionRemoveEnqueueFn,
...
func TagActionCreateFn(dto *TagEntity, query fireback.QueryDSL) (*TagEntity, *fireback.IError) {
	...
	actionEvent, eventErr := NewTagCreatedEvent(dto, &query)
...
func TagUpdateExec(dbref *gorm.DB, query fireback.QueryDSL, fields *TagEntity) (*TagEntity, *fireback.IError) {
	...
	actionEvent, eventErr := NewTagUpdatedEvent(fields, &query)
	if actionEvent != nil && eventErr == nil {
		fireback.GetEventBusInstance().FireEvent(query, *actionEvent)
	} else {
...
func TagActionRemoveEnqueueFn(req fireback.DeleteRequest, query fireback.QueryDSL) (*fireback.DeleteResponse, *fireback.IError) {
	refl := reflect.ValueOf(&TagEntity{})
	query.ActionRequires = []fireback.PermissionInfo{PERM_ROOT_TAG_DELETE}
	return fireback.RemoveEntityEnqueue[TagEntity](req, query, refl)
}
...
func CastTagFromCli(c *cli.Command) *TagEntity {
	...
	if c.IsSet("description") {
		emigo.ParseNullable(c.String("description"), &template.Description)
	}
	return template
}
...
var TagImportExportCommands = []*cli.Command{
	{
		...
		Action: func(ctx context.Context, c *cli.Command) error {
			data := fireback.ContentImport[TagEntity]{}
	...
	},
	{
		...
		Action: func(ctx context.Context, c *cli.Command) error {
			if seeders, err := fireback.GetSeederFilenames(tagSeedersFs, ""); err != nil {
				return err
			} else {
				if len(seeders) == 0 {
...
var TagCliCommands []*cli.Command = []*cli.Command{
	...
	TAG_ACTION_PATCH.ToCli(),
	TagCreateCmd,
	&TagAskCmd,
	&TagCreateInteractiveCmd,
	fireback.GetCommonRemoveQuery(
		reflect.ValueOf(&TagEntity{}).Elem(),
		TagActions.RemoveEnqueue,
	),
}
...
var TAG_ACTION_PATCH = fireback.Module3Action{
	...
	Description: "Update the Tag entity by unique id",
	CliName:     "update",
	CliAction: func(c *cli.Command, security *fireback.SecurityModel) error {
		result, err := fireback.CliPatchEntity(c, TagActions.Update, security)
		fireback.HandleActionInCli(c, result, err, map[string]map[string]string{})
		if err != nil {
			return err
		}
...
var TAG_ACTION_DELETE_ENQUEUE = fireback.Module3Action{
	Method: "POST",
	Url:    "/tag-remove",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_TAG_DELETE},
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpRemoveEnqueueEntity(c, TagActions.RemoveEnqueue)
		},
	},
	Action:         TagActions.RemoveEnqueue,
