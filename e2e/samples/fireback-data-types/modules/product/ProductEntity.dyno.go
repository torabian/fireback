...
import (
	...
	metas "github.com/torabian/fireback/e2e/samples/fireback-data-types/modules/product/metas"
...
type ProductEntity struct {
	...
	Sku emigo.Nullable[string] `json:"sku" xml:"sku" yaml:"sku"        `
	// Average rating of the product (optional)
	Rating emigo.Nullable[float64] `json:"rating" xml:"rating" yaml:"rating"        `
	// Price of the product
	Price float64 `json:"price" xml:"price" yaml:"price"        `
	// Weight of the product in kilograms (optional)
	Weight                emigo.Nullable[float32] `json:"weight" xml:"weight" yaml:"weight"        `
	...
	IsFeatured emigo.Nullable[bool] `json:"isFeatured" xml:"isFeatured" yaml:"isFeatured"        `
...
func CastProductFromCli(c *cli.Command) *ProductEntity {
	...
	if c.IsSet("sku") {
		emigo.ParseNullable(c.String("sku"), &template.Sku)
	}
	if c.IsSet("price") {
	...
	if c.IsSet("is-featured") {
		emigo.ParseNullable(c.String("is-featured"), &template.IsFeatured)
	}
