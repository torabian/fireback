...
export type GetTimezoneGroupsQs = {
}
export type GetTimezoneGroupsUrlParams = {
}
export type GetTimezoneGroupsHeaders = {
}
export function useGetTimezoneGroups({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetTimezoneGroupsQs}) {
...
useGetTimezoneGroups.UKEY = "*abac.TimezoneGroupEntity"