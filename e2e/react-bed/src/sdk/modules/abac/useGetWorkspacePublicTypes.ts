...
export type GetWorkspacePublicTypesQs = {
}
export type GetWorkspacePublicTypesUrlParams = {
}
export type GetWorkspacePublicTypesHeaders = {
}
export function useGetWorkspacePublicTypes({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspacePublicTypesQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<QueryWorkspaceTypesPubliclyActionResDto>, any>(["*abac.QueryWorkspaceTypesPubliclyActionResDto", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetWorkspacePublicTypes.UKEY = "*abac.QueryWorkspaceTypesPubliclyActionResDto"