...
export type GetRegionalContentsExportQs = {
}
export type GetRegionalContentsExportUrlParams = {
}
export type GetRegionalContentsExportHeaders = {
}
export function useGetRegionalContentsExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetRegionalContentsExportQs}) {
...
useGetRegionalContentsExport.UKEY = "*abac.RegionalContentEntity"