...
export type GetFilesExportQs = {
}
export type GetFilesExportUrlParams = {
}
export type GetFilesExportHeaders = {
}
export function useGetFilesExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetFilesExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<FileEntity>, any>(["*abac.FileEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetFilesExport.UKEY = "*abac.FileEntity"