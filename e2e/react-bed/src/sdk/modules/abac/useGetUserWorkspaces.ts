...
export type GetUserWorkspacesQs = {
}
export type GetUserWorkspacesUrlParams = {
}
export type GetUserWorkspacesHeaders = {
}
export function useGetUserWorkspaces({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetUserWorkspacesQs}) {
...
useGetUserWorkspaces.UKEY = "*abac.UserWorkspaceEntity"