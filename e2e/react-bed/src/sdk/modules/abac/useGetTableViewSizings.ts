...
export type GetTableViewSizingsQs = {
}
export type GetTableViewSizingsUrlParams = {
}
export type GetTableViewSizingsHeaders = {
}
export function useGetTableViewSizings({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetTableViewSizingsQs}) {
...
useGetTableViewSizings.UKEY = "*abac.TableViewSizingEntity"