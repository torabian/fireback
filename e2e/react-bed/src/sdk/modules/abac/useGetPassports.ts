...
export type GetPassportsQs = {
}
export type GetPassportsUrlParams = {
}
export type GetPassportsHeaders = {
}
export function useGetPassports({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetPassportsQs}) {
...
useGetPassports.UKEY = "*abac.PassportEntity"