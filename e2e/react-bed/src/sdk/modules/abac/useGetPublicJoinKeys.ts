...
export type GetPublicJoinKeysQs = {
}
export type GetPublicJoinKeysUrlParams = {
}
export type GetPublicJoinKeysHeaders = {
}
export function useGetPublicJoinKeys({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetPublicJoinKeysQs}) {
...
useGetPublicJoinKeys.UKEY = "*abac.PublicJoinKeyEntity"