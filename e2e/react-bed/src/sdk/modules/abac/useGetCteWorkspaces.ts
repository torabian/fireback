...
export type GetCteWorkspacesQs = {
}
export type GetCteWorkspacesUrlParams = {
}
export type GetCteWorkspacesHeaders = {
}
export function useGetCteWorkspaces({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetCteWorkspacesQs}) {
...
useGetCteWorkspaces.UKEY = "*abac.WorkspaceEntity"