...
setToken (value: string) {
  ...
  * @returns {string}
  **/
get exchangeKey () { return this.#exchangeKey }
/**
  * 
  * @type {string}
  **/
...
setExchangeKey (value: string) {
  ...
  **/
get userWorkspaces () { return this.#userWorkspaces }
/**
  * 
  * @type {UserWorkspaceEntity[]}
  **/
	...
	**/
	applyFromObject(data = {}) {
		const d = data as Partial<UserSessionDto>;
			if (d.passport !== undefined) { this.passport = d.passport }
			if (d.token !== undefined) { this.token = d.token }
			if (d.exchangeKey !== undefined) { this.exchangeKey = d.exchangeKey }
			if (d.userWorkspaces !== undefined) { this.userWorkspaces = d.userWorkspaces }
...
get userWorkspaces() {
	...
	**/
	...
	copyWith(partial: PartialDeep<UserSessionDtoType>): InstanceType<typeof UserSessionDto> {
