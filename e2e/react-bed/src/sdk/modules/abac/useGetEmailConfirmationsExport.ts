...
import { execApiFn, IResponseList } from "../../core/http-tools";
    ...
    } from "../abac/EmailConfirmationEntity"
...
export function useGetEmailConfirmationsExport({
  ...
  const query$ = useQuery<any, any, IResponseList<EmailConfirmationEntity>, any>(["*abac.EmailConfirmationEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetEmailConfirmationsExport.UKEY = "*abac.EmailConfirmationEntity"