...
export type GetWorkspaceInvitesExportQs = {
}
export type GetWorkspaceInvitesExportUrlParams = {
}
export type GetWorkspaceInvitesExportHeaders = {
}
export function useGetWorkspaceInvitesExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspaceInvitesExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<WorkspaceInviteEntity>, any>(["*abac.WorkspaceInviteEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetWorkspaceInvitesExport.UKEY = "*abac.WorkspaceInviteEntity"