...
import { execApiFn, IResponseList } from "../../core/http-tools";
    import {
        WorkspaceTypeEntity,
    } from "../abac/WorkspaceTypeEntity"
// Fireback gives the option to have typesafe query string
export type GetWorkspaceTypesQs = {
}
export type GetWorkspaceTypesUrlParams = {
}
export type GetWorkspaceTypesHeaders = {
}
export function useGetWorkspaceTypes({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspaceTypesQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<WorkspaceTypeEntity>, any>(["*abac.WorkspaceTypeEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetWorkspaceTypes.UKEY = "*abac.WorkspaceTypeEntity"