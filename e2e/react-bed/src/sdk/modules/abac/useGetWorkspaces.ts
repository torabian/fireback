...
export type GetWorkspacesQs = {
}
export type GetWorkspacesUrlParams = {
}
export type GetWorkspacesHeaders = {
}
export function useGetWorkspaces({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspacesQs}) {
...
useGetWorkspaces.UKEY = "*abac.WorkspaceEntity"