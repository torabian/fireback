...
export type GetPublicJoinKeysExportQs = {
}
export type GetPublicJoinKeysExportUrlParams = {
}
export type GetPublicJoinKeysExportHeaders = {
}
export function useGetPublicJoinKeysExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetPublicJoinKeysExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<PublicJoinKeyEntity>, any>(["*abac.PublicJoinKeyEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetPublicJoinKeysExport.UKEY = "*abac.PublicJoinKeyEntity"