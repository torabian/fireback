...
export type GetEmailSendersQs = {
}
export type GetEmailSendersUrlParams = {
}
export type GetEmailSendersHeaders = {
}
export function useGetEmailSenders({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetEmailSendersQs}) {
...
useGetEmailSenders.UKEY = "*abac.EmailSenderEntity"