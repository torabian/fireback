...
export type GetCteAppMenusQs = {
}
export type GetCteAppMenusUrlParams = {
}
export type GetCteAppMenusHeaders = {
}
export function useGetCteAppMenus({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetCteAppMenusQs}) {
...
useGetCteAppMenus.UKEY = "*abac.AppMenuEntity"