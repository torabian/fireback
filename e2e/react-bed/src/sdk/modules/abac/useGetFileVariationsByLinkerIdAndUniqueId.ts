...
export function useGetFileVariationsByLinkerIdAndUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/file/variations/:linkerId/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*abac.FileVariations"], fn, {
    cacheTime: 1001,
    retry: false,
