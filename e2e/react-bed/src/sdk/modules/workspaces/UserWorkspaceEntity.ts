...
// Class body
export type UserWorkspaceEntityKeys = keyof typeof UserWorkspaceEntity.Fields;
export class UserWorkspaceEntity extends BaseEntity {
  ...
  public static definition = {
    ...
    cliShort: "user",
    description:
      "Manage the workspaces that user belongs to (either its himselves or adding by invitation)",
