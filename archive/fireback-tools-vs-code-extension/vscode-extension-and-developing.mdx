...
<span style={{color: 'red'}}>**Important:** 
    Fireback VSCode extension is discontinued. The reason is I do not have enough time
    to manage such heavy project.
</span> Instead, you need to install following VSCode extensions:

- https://marketplace.visualstudio.com/items?itemName=emeraldwalk.RunOnSave
- https://marketplace.visualstudio.com/items?itemName=redhat.vscode-yaml
- https://marketplace.visualstudio.com/items?itemName=augustocdias.tasks-shell-input

By installing them, you'll get auto completion, run on save for Module3.yml files.


For each release, there is a VSCode extension coming with Fireback, which could provide
a visual yaml editor, and autosuggestions. Still on version 1.1.28, The "Run on Save"
...
<span style={{color: 'red'}}>**Important:** This extension autocompletion is not good enough. You need to install Redhat Yaml Language Support
Plugin in VSCode. Upon first compiling of Fireback projects, json schema will be created in .jsonschemas
folder for you.</span>
