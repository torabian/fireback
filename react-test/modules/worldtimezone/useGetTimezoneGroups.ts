...
export function useGetTimezoneGroups({
  ...
  const query$ = useQuery<any, any, IResponseList<TimezoneGroupEntity>, any>(["*worldtimezone.TimezoneGroupEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetTimezoneGroups.UKEY = "*worldtimezone.TimezoneGroupEntity"