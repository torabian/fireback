...
func (x *WalletEventDto) Json() string {
	if x != nil {
...
func GetWalletEventDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWalletEventDtoFromCli(c emigo.CliCastable) WalletEventDto {
	data := WalletEventDto{}
