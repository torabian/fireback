...
type WalletProviderConfigDto struct {
	...
	ProviderType string `json:"providerType" validate:"required" yaml:"providerType"`
...
func (x *WalletProviderConfigDto) Json() string {
	if x != nil {
...
func GetWalletProviderConfigDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWalletProviderConfigDtoFromCli(c emigo.CliCastable) WalletProviderConfigDto {
	data := WalletProviderConfigDto{}
