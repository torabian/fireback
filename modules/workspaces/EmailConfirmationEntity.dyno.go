...
type EmailConfirmationEntity struct {
	...
	Children         []*EmailConfirmationEntity `csv:"-" gorm:"-" sql:"-" json:"children,omitempty" yaml:"children,omitempty"`
	LinkedTo         *EmailConfirmationEntity   `csv:"-" yaml:"-" gorm:"-" json:"-" sql:"-"`
}

func EmailConfirmationEntityStream(q QueryDSL) (chan []*EmailConfirmationEntity, *QueryResultMeta, error) {
...
func EmailConfirmationsActionQueryString(keyword string, page int) ([]string, *QueryResultMeta, error) {
	searchFields := []string{
		`unique_id %"{keyword}"%`,
		`name %"{keyword}"%`,
	}
...
var EMAIL_CONFIRMATION_ACTION_TABLE = Module3Action{
	Name:          "table",
...
var EMAIL_CONFIRMATION_ACTION_QUERY = Module3Action{
	Method: "GET",
...
var EMAIL_CONFIRMATION_ACTION_GET_ONE = Module3Action{
	Method: "GET",
...
var EMAIL_CONFIRMATION_ACTION_POST_ONE = Module3Action{
	Name:          "create",
...
var EMAIL_CONFIRMATION_ACTION_PATCH = Module3Action{
	Name:          "update",
...
var EMAIL_CONFIRMATION_ACTION_PATCH_BULK = Module3Action{
	Method: "PATCH",
	Url:    "/email-confirmations",
	SecurityModel: &SecurityModel{
		ActionRequires: []PermissionInfo{PERM_ROOT_EMAIL_CONFIRMATION_UPDATE},
...
var EMAIL_CONFIRMATION_ACTION_DELETE = Module3Action{
	Method: "DELETE",
	Url:    "/email-confirmation",
	Format: "DELETE_DSL",
	SecurityModel: &SecurityModel{
 ...
 **/
var AppendEmailConfirmationRouter = func(r *[]Module3Action) {}

func GetEmailConfirmationModule3Actions() []Module3Action {
