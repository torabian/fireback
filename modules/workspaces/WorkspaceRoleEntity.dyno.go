...
func CastWorkspaceRoleFromCli(c *cli.Context) *WorkspaceRoleEntity {
	...
	if c.IsSet("user-workspace-id") {
		template.UserWorkspaceId = NewStringAutoNull(c.String("user-workspace-id"))
	}
	if c.IsSet("role-id") {
