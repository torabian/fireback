...
type WorkspaceTypeEntity struct {
	...
	Translations     []*WorkspaceTypeEntityPolyglot `json:"translations,omitempty" gorm:"foreignKey:LinkerId;references:UniqueId;constraint:OnDelete:CASCADE"`
...
func (x *WorkspaceTypeEntity) Seeder() string {
	obj := WorkspaceTypeActionSeederInit()
	v, _ := json.MarshalIndent(obj, "", "  ")
	return string(v)
}
func WorkspaceTypeActionSeederInit() *WorkspaceTypeEntity {
	tildaRef := "~"
	_ = tildaRef
	entity := &WorkspaceTypeEntity{
		Title:       &tildaRef,
...
var WorkspaceTypeImportExportCommands = []cli.Command{
	...
	},
	{
		...
		Action: func(c *cli.Context) error {
			seed := WorkspaceTypeActionSeederInit()
