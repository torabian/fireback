...
func CastWorkspaceFromCli(c *cli.Context) *WorkspaceEntity {
	...
	if c.IsSet("type-id") {
		template.TypeId = NewStringAutoNull(c.String("type-id"))
	}
	return template
}
func WorkspaceSyncSeederFromFs(fsRef *embed.FS, fileNames []string, q QueryDSL) {
	SeederFromFSImport(
		q,
...
var WorkspaceEntityBundle = EntityBundle{
	...
	MainSchema:   &WorkspaceEntity{},
	SeederSchema: Seeder[WorkspaceEntity]{},
