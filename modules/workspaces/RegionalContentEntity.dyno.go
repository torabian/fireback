...
import (
	...
	seeders "pixelplux.com/fireback/modules/workspaces/seeders/RegionalContent"
	metas "pixelplux.com/fireback/modules/workspaces/metas"
)
...
var RegionalContentImportExportCommands = []cli.Command{
	...
	},
	{
		...
		Action: func(c *cli.Context) error {
			...
			RegionalContentActionSeederInit(f, c.String("file"), c.String("format"))
			return nil
		},
	},
	{
