...
var WorkspacesTranslations map[string]map[string]string = map[string]map[string]string{
	WorkspacesMessageCode.InviteToWorkspaceMailSenderMissing: {
	...
	WorkspacesMessageCode.UserWhichHasThisTokenDoesNotExist: {
	...
	WorkspacesMessageCode.SelectWorkspaceId: {
