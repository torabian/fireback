...
export function usePatchNotificationWorkspaceConfig(props?: PatchProps) {
  ...
  const url = "/notification/workspace/config".substr(1);
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<NotificationConfigEntity>) {
          queryClient?.setQueriesData("*workspaces.NotificationConfigEntity", (data: any) =>
