...
export function useGetRegionalContents({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const query$ = useQuery<any, any, IResponseList<RegionalContentEntity>, any>(["*workspaces.RegionalContentEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
