...
import { execApiFn, IResponseList } from "../../core/http-tools";
    ...
    } from "../workspaces/WorkspaceConfigEntity"
...
export function useGetWorkspaceConfigsExport({
  ...
  const query$ = useQuery<any, any, IResponseList<WorkspaceConfigEntity>, any>(["*workspaces.WorkspaceConfigEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetWorkspaceConfigsExport.UKEY = "*workspaces.WorkspaceConfigEntity"