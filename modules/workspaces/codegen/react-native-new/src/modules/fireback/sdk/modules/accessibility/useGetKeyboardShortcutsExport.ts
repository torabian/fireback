...
export function useGetKeyboardShortcutsExport({
  ...
  const query$ = useQuery<any, any, IResponseList<KeyboardShortcutEntity>, any>(["*accessibility.KeyboardShortcutEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
  ...
  return { 
    query: query$,
    items,
    keyExtractor: (item: KeyboardShortcutEntity) => item.uniqueId,
  };
}
useGetKeyboardShortcutsExport.UKEY = "*accessibility.KeyboardShortcutEntity"