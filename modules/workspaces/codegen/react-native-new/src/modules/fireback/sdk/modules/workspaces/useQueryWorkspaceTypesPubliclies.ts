...
export function useQueryWorkspaceTypesPubliclies({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/query-workspace-types-publiclies".substr(1);
...
useQueryWorkspaceTypesPubliclies.UKEY = "*workspaces.WorkspaceTypeEntity"