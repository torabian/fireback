...
export function useGetUrwQuery({
  ...
  const query$ = useQuery<any, any, IResponseList<QueryUserRoleWorkspacesActionResDto>, any>(["*workspaces.QueryUserRoleWorkspacesActionResDto", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
