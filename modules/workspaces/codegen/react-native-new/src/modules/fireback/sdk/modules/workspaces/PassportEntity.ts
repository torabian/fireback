...
// Class body
export type PassportEntityKeys = keyof typeof PassportEntity.Fields;
export class PassportEntity extends BaseEntity {
  ...
  */
  ...
  public static definition = {
    ...
    description:
      'Represent a mean to login in into the system, each user could have multiple passport (email, phone) and authenticate into the system.',
  };
