...
// Class body
export type TimezoneGroupEntityKeys = keyof typeof TimezoneGroupEntity.Fields;
export class TimezoneGroupEntity extends BaseEntity {
  ...
  public static Navigation = {
    ...
    editUtcItems(linkerId: string, uniqueId: string, locale?: string) {
      return `${
        locale ? "/" + locale : ""
      }/timezone-group/${linkerId}/utc_items/edit/${uniqueId}`;
    },
    createUtcItems(linkerId: string, locale?: string) {
      return `${
        locale ? "/" + locale : ""
      }/timezone-group/${linkerId}/utc_items/new`;
    },
  };
