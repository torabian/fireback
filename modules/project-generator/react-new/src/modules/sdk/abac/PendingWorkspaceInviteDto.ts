...
export class PendingWorkspaceInviteDto {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<PendingWorkspaceInviteDto>;
  ...
  /**
   * Creates an instance of PendingWorkspaceInviteDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: PendingWorkspaceInviteDtoType) {
    return new PendingWorkspaceInviteDto(possibleDtoObject);
  }
  /**
   * Creates an instance of PendingWorkspaceInviteDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<PendingWorkspaceInviteDtoType>) {
    return new PendingWorkspaceInviteDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<PendingWorkspaceInviteDtoType>,
  ): InstanceType<typeof PendingWorkspaceInviteDto> {
    return new PendingWorkspaceInviteDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof PendingWorkspaceInviteDto> {
    return new PendingWorkspaceInviteDto(this.toJSON());
  }
}
export abstract class PendingWorkspaceInviteDtoFactory {
  abstract create(data: unknown): PendingWorkspaceInviteDto;
}
/**
 * The base type definition for pendingWorkspaceInviteDto
 **/
export type PendingWorkspaceInviteDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace PendingWorkspaceInviteDtoType {}
