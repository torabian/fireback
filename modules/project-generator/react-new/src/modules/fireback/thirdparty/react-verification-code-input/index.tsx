...
export default class ReactCodeInput extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={`${'rc-react-code-input-container'} ${className}`}
        style={ROOT_STYLE}
      >
        {title && <p className={'rc-title'}>{title}</p>}
        <div className={'rc-react-code-input'}>
        ...
        {loading && (
          <div className={'rc-loading'} style={LOADING_STYLE}>
