...
// The old "Generated by fireback 1.3.2" UserEntity carried this as a nested
// sub-entity (UserPrimaryAddress); the newer generated UserDto doesn't have an
// equivalent yet, and nothing outside this mock data file ever needed it, so it's
// reconstructed here rather than in a shared location.
interface UserPrimaryAddress {
...
export const MockUsers = new MemoryEntity<UserDto>(
