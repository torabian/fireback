...
/**
 * The base class definition for workspaceRoleDto
 **/
export class WorkspaceRoleDto {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<WorkspaceRoleDto>;
  ...
  /**
   * Creates an instance of WorkspaceRoleDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: WorkspaceRoleDtoType) {
    return new WorkspaceRoleDto(possibleDtoObject);
  }
  /**
   * Creates an instance of WorkspaceRoleDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<WorkspaceRoleDtoType>) {
    return new WorkspaceRoleDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<WorkspaceRoleDtoType>,
  ): InstanceType<typeof WorkspaceRoleDto> {
    return new WorkspaceRoleDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof WorkspaceRoleDto> {
    return new WorkspaceRoleDto(this.toJSON());
  }
}
export abstract class WorkspaceRoleDtoFactory {
  abstract create(data: unknown): WorkspaceRoleDto;
}
/**
 * The base type definition for workspaceRoleDto
 **/
export type WorkspaceRoleDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace WorkspaceRoleDtoType {}
