 ...
 **/
export class AppMenuOptionalDto {
  /**
   *
   * @type {string}
   **/
  ...
  set href(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#href = correctType ? value : String(value);
  }
  setHref(value: string | null | undefined) {
    this.href = value;
    return this;
  }
  /**
  ...
  set icon(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#icon = correctType ? value : String(value);
  }
  setIcon(value: string | null | undefined) {
    this.icon = value;
    return this;
  }
  /**
   ...
   * @type {string}
   **/
  #activeMatcher?: string | null = undefined;
  /**
   * Custom window location url matchers, for inner screens.
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  set activeMatcher(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#activeMatcher = correctType ? value : String(value);
  }
  setActiveMatcher(value: string | null | undefined) {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<AppMenuOptionalDto>;
  ...
  /**
   * Creates an instance of AppMenuOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: AppMenuOptionalDtoType) {
    return new AppMenuOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of AppMenuOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<AppMenuOptionalDtoType>) {
    return new AppMenuOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<AppMenuOptionalDtoType>,
  ): InstanceType<typeof AppMenuOptionalDto> {
    return new AppMenuOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof AppMenuOptionalDto> {
    return new AppMenuOptionalDto(this.toJSON());
  }
}
export abstract class AppMenuOptionalDtoFactory {
  abstract create(data: unknown): AppMenuOptionalDto;
}
/**
 * The base type definition for appMenuOptionalDto
 **/
export type AppMenuOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace AppMenuOptionalDtoType {}
