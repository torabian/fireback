 ...
 **/
export class WorkspaceTypeOptionalDto {
  /**
   *
   * @type {string}
   **/
  ...
  set slug(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#slug = correctType ? value : String(value);
  }
  setSlug(value: string | null | undefined) {
    this.slug = value;
    return this;
  }
  /**
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<WorkspaceTypeOptionalDto>;
  ...
  /**
   * Creates an instance of WorkspaceTypeOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: WorkspaceTypeOptionalDtoType) {
    return new WorkspaceTypeOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of WorkspaceTypeOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<WorkspaceTypeOptionalDtoType>) {
    return new WorkspaceTypeOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<WorkspaceTypeOptionalDtoType>,
  ): InstanceType<typeof WorkspaceTypeOptionalDto> {
    return new WorkspaceTypeOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof WorkspaceTypeOptionalDto> {
    return new WorkspaceTypeOptionalDto(this.toJSON());
  }
}
export abstract class WorkspaceTypeOptionalDtoFactory {
  abstract create(data: unknown): WorkspaceTypeOptionalDto;
}
/**
 * The base type definition for workspaceTypeOptionalDto
 **/
export type WorkspaceTypeOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace WorkspaceTypeOptionalDtoType {}
