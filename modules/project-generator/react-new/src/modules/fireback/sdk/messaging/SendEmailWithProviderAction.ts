...
export class SendEmailWithProviderActionReq {
   ...
   **/
  #emailProvider!: MOne<EmailProviderEntity>;
  /**
   *
   ...
   **/
  set emailProvider(
    value: MOne<EmailProviderEntity> | InstanceType<typeof EmailProviderEntity>,
  ) {
    // For objects, the sub type needs to always be instance of the sub class.
    if (value instanceof MOne) {
      this.#emailProvider = value;
    } else if (value instanceof EmailProviderEntity) {
      this.#emailProvider = MOne.of(value);
    } else {
      this.#emailProvider = MOne.of(new EmailProviderEntity(value));
    }
  }
  setEmailProvider(
    value: MOne<EmailProviderEntity> | InstanceType<typeof EmailProviderEntity>,
  ...
  #lateInitFields(data = {}) {
    ...
    if (!(d.emailProvider instanceof EmailProviderEntity)) {
      this.emailProvider = MOne.of(
        new EmailProviderEntity(d.emailProvider || {}),
      );
    }
  }
  /**
