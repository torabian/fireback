...
var postSeedersFs *embed.FS = nil
func ResetPostSeeders(fs *embed.FS) {
	postSeedersFs = fs
}
...
var PostImportExportCommands = []cli.Command{
    ...
    var PostCliCommands []cli.Command = []cli.Command{
      POST_ACTION_QUERY.ToCli(),
      POST_ACTION_TABLE.ToCli(),
      PostCreateCmd,
      PostUpdateCmd,
...
var POST_ACTION_TABLE = workspaces.Module2Action{
  Name:    "table",
  ActionName: "table",
