...
type SuggestionModuleConfig struct {
...
func SuggestionModuleSetup(cfg *SuggestionModuleConfig) *fireback.ModuleProvider {
	module := &fireback.ModuleProvider{
		...
		ActionsBundle: GetSuggestionActionsBundle(),
