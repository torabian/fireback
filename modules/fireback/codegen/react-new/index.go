...
//go:embed .eslintignore .eslintrc.json .nojekyll package-lock.json package.json README.md tsconfig.json types.d.ts Makefile .gitignore src/modules src/styles src/apps/projectname  src/index.tsx public/* .vscode src/apps/projectname/.env.capacitor  src/apps/projectname/.env.local.txt src/apps/projectname/.env.githubpages src/apps/projectname/.env.static
