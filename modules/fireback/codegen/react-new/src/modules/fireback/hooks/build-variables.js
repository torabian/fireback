const process = {
  env:
  {
    "VITE_REMOTE_SERVICE": "http://localhost:4500/",
    "PUBLIC_URL": "/",
    "VITE_PUBLIC_URL": "/",
    "VITE_DEFAULT_ROUTE": "/{locale}/dashboard",
    "TARGET_APP": "projectname",
    "VITE_ALLOW_OS_LOGIN": "false",
    "VITE_SUPPORTED_LANGUAGES": "fa,en",
    "VITE_FEATURE_DASHBOARD": "true",
    "VITE_USE_HASH_ROUTER": "true",
    "VITE_INACCURATE_MOCK_MODE": "true",
    "VITE_TITLE": "projectname",
    "VITE_ALLOW_REMOTE_LOGIN": "true",
    "VITE_FORCE_AUTHENTICATION": "true",
    "VITE_GITHUB_DEMO": "true"
  }
}

var BUILD_VARIABLES2 = {
  /**
   * The location of the api endpoint which will be used to communicate as backend.
   */
  REMOTE_SERVICE: process.env.VITE_REMOTE_SERVICE,
   ...
   */
  DEFAULT_ROUTE: process.env.VITE_DEFAULT_ROUTE,
   ...
   */
  ALLOW_OS_LOGIN: process.env.VITE_ALLOW_OS_LOGIN,

  /**
   * Supported languages in the app, which would import the corresponding
   * translation file.
   */
  SUPPORTED_LANGUAGES: process.env.VITE_SUPPORTED_LANGUAGES,
   ...
   */
  USE_HASH_ROUTER: process.env.VITE_USE_HASH_ROUTER,
   ...
   */
  INACCURATE_MOCK_MODE: process.env.VITE_INACCURATE_MOCK_MODE,
   ...
   */
  GITHUB_DEMO: process.env.VITE_GITHUB_DEMO,

  /**
   * This is used in few places, but never tested.
   * It's forcing application to always be in an speific locale
   */
  FORCED_LOCALE: process.env.VITE_FORCED_LOCALE,

  /**
   * This is also to prevent user be able to change the interface theme.
   */
  FORCE_APP_THEME: process.env.VITE_FORCE_APP_THEME,

  /**
   * The route, where user will be navigated upon signout from
   * the ui interface
   */
  NAVIGATE_ON_SIGNOUT: process.env.VITE_NAVIGATE_ON_SIGNOUT
}


export const BUILD_VARIABLES = BUILD_VARIABLES2;