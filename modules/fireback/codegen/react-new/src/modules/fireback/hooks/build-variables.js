export const BUILD_VARIABLES = {
     ...
     */
    REMOTE_SERVICE: process.env.REACT_APP_REMOTE_SERVICE,
     ...
     */
    DEFAULT_ROUTE: process.env.REACT_APP_DEFAULT_ROUTE,
     ...
     */
    ALLOW_OS_LOGIN: process.env.REACT_APP_ALLOW_OS_LOGIN,

    /**
     * Supported languages in the app, which would import the corresponding
     * translation file.
     */
    SUPPORTED_LANGUAGES: process.env.REACT_APP_SUPPORTED_LANGUAGES,
     ...
     */
    USE_HASH_ROUTER: process.env.REACT_APP_USE_HASH_ROUTER,
     ...
     */
    INACCURATE_MOCK_MODE: process.env.REACT_APP_INACCURATE_MOCK_MODE,
