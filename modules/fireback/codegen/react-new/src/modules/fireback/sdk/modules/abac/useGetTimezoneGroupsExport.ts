...
import { execApiFn, IResponseList } from "../../core/http-tools";
    import {
        TimezoneGroupEntity,
    } from "../abac/TimezoneGroupEntity"
// Fireback gives the option to have typesafe query string
export type GetTimezoneGroupsExportQs = {
}
export type GetTimezoneGroupsExportUrlParams = {
}
export type GetTimezoneGroupsExportHeaders = {
}
export function useGetTimezoneGroupsExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetTimezoneGroupsExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<TimezoneGroupEntity>, any>(["*abac.TimezoneGroupEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetTimezoneGroupsExport.UKEY = "*abac.TimezoneGroupEntity"