...
export function useDeleteWebPushConfig(props?: DeleteProps) {
  ...
  const mutation = useMutation<IDeleteResponse, IDeleteResponse, DeleteRequest>(
    fn
  );
  const fnUpdater = (
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IDeleteResponse) {
          ...
          queryClient?.invalidateQueries("*fireback.WebPushConfigEntity");
          resolve(response);
        },
        onError(error: any) {
