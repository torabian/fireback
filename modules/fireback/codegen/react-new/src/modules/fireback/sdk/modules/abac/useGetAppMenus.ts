...
export type GetAppMenusQs = {
}
export type GetAppMenusUrlParams = {
}
export type GetAppMenusHeaders = {
}
export function useGetAppMenus({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetAppMenusQs}) {
...
useGetAppMenus.UKEY = "*abac.AppMenuEntity"