...
export type GetRegionalContentsQs = {
}
export type GetRegionalContentsUrlParams = {
}
export type GetRegionalContentsHeaders = {
}
export function useGetRegionalContents({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetRegionalContentsQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<RegionalContentEntity>, any>(["*abac.RegionalContentEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetRegionalContents.UKEY = "*abac.RegionalContentEntity"