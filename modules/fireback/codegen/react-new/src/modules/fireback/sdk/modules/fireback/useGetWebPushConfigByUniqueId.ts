...
export function useGetWebPushConfigByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/web-push-config/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*fireback.WebPushConfigEntity"], fn, {
    cacheTime: 1001,
    retry: false,
