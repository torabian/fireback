...
import { execApiFn, type IResponseList } from "../../core/http-tools";
    import {
        EmailProviderEntity,
    } from "../abac/EmailProviderEntity"
// Fireback gives the option to have typesafe query string
export type GetEmailProvidersQs = {
}
export type GetEmailProvidersUrlParams = {
}
export type GetEmailProvidersHeaders = {
}
export function useGetEmailProviders({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetEmailProvidersQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<EmailProviderEntity>, any>(["*abac.EmailProviderEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetEmailProviders.UKEY = "*abac.EmailProviderEntity"