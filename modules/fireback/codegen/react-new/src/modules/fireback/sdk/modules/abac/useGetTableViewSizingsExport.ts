...
import { execApiFn, IResponseList } from "../../core/http-tools";
    ...
    } from "../abac/TableViewSizingEntity"
// Fireback gives the option to have typesafe query string
export type GetTableViewSizingsExportQs = {
}
export type GetTableViewSizingsExportUrlParams = {
}
export type GetTableViewSizingsExportHeaders = {
}
export function useGetTableViewSizingsExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetTableViewSizingsExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<TableViewSizingEntity>, any>(["*abac.TableViewSizingEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetTableViewSizingsExport.UKEY = "*abac.TableViewSizingEntity"