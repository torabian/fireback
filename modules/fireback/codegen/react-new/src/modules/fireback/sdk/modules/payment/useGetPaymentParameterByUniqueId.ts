...
export function useGetPaymentParameterByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/payment-parameter/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*payment.PaymentParameterEntity"], fn, {
    cacheTime: 1001,
    retry: false,
