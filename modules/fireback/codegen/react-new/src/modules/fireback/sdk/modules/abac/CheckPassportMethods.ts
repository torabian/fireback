...
export const useCheckPassportMethodsActionQuery = (
	...
	const result = useQuery({
		queryKey: [
			CheckPassportMethodsAction.NewUrl (
				options?.qs
			)
		],
		queryFn: fn,
...
export class CheckPassportMethodsAction { //
  ...
  static NewUrl = (
	qs?: URLSearchParams
		...
		CheckPassportMethodsAction.URL,
		 undefined,
		qs
	);
  static Method = 'get';
	static Fetch$ = async (
		...
		return fetchx<GResponse<CheckPassportMethodsActionRes>, unknown, unknown>(
			overrideUrl ?? CheckPassportMethodsAction.NewUrl(
				qs
			),
			{
	...
	static Fetch = async (
		init?: TypedRequestInit<unknown, unknown>,
		{
			...
			: {
				creatorFn?: ((item: unknown) => CheckPassportMethodsActionRes) | undefined,
			qs?: URLSearchParams,
			ctx?: FetchxContext,
			onMessage?: (ev: MessageEvent) => void,
			overrideUrl?: string,		
		...
		creatorFn = creatorFn || ((item) => new CheckPassportMethodsActionRes(item))
...
setFacebook (value: boolean) {
  ...
  * @returns {string}
  **/
get googleOAuthClientKey () { return this.#googleOAuthClientKey }
/**
  * 
  * @type {string}
  **/
...
setGoogleOAuthClientKey (value: string) {
  ...
  * @returns {string}
  **/
get facebookAppId () { return this.#facebookAppId }
/**
  * 
  * @type {string}
  **/
...
setFacebookAppId (value: string) {
  ...
  * @returns {boolean}
  **/
get enabledRecaptcha2 () { return this.#enabledRecaptcha2 }
/**
  * 
  * @type {boolean}
  **/
...
setEnabledRecaptcha2 (value: boolean) {
  ...
  * @returns {string}
  **/
get recaptcha2ClientKey () { return this.#recaptcha2ClientKey }
/**
  * 
  * @type {string}
  **/
...
setRecaptcha2ClientKey (value: string) {
	...
	**/
	applyFromObject(data = {}) {
		const d = data as Partial<CheckPassportMethodsActionRes>;
			if (d.email !== undefined) { this.email = d.email }
			if (d.phone !== undefined) { this.phone = d.phone }
			if (d.google !== undefined) { this.google = d.google }
			if (d.facebook !== undefined) { this.facebook = d.facebook }
			if (d.googleOAuthClientKey !== undefined) { this.googleOAuthClientKey = d.googleOAuthClientKey }
			if (d.facebookAppId !== undefined) { this.facebookAppId = d.facebookAppId }
			if (d.enabledRecaptcha2 !== undefined) { this.enabledRecaptcha2 = d.enabledRecaptcha2 }
			if (d.recaptcha2ClientKey !== undefined) { this.recaptcha2ClientKey = d.recaptcha2ClientKey }
	}
	/**
	...
	**/
	static with(partialDtoObject: PartialDeep<CheckPassportMethodsActionResType>) {
		return new CheckPassportMethodsActionRes(partialDtoObject);
	}
	copyWith(partial: PartialDeep<CheckPassportMethodsActionResType>): InstanceType<typeof CheckPassportMethodsActionRes> {
