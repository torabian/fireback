...
export function useGetInvoiceTransactionByUniqueId({ 
    queryOptions,
    execFnOverride,
    query,
    queryClient,
  ...
  const url = "/invoice-transaction/:uniqueId".substr(1);
  ...
  const query$ = useQuery([options, query, "*payment.InvoiceTransactionEntity"], fn, {
    cacheTime: 1001,
    retry: false,
