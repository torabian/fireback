...
import { execApiFn, IResponseList } from "../../core/http-tools";
    import {
        WorkspaceEntity,
    } from "../abac/WorkspaceEntity"
// Fireback gives the option to have typesafe query string
export type GetWorkspacesExportQs = {
}
export type GetWorkspacesExportUrlParams = {
}
export type GetWorkspacesExportHeaders = {
}
export function useGetWorkspacesExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspacesExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<WorkspaceEntity>, any>(["*abac.WorkspaceEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetWorkspacesExport.UKEY = "*abac.WorkspaceEntity"