...
import { execApiFn, type IResponseList } from "../../core/http-tools";
    import {
        AppMenuEntity,
    } from "../abac/AppMenuEntity"
// Fireback gives the option to have typesafe query string
export type GetAppMenusExportQs = {
}
export type GetAppMenusExportUrlParams = {
}
export type GetAppMenusExportHeaders = {
}
export function useGetAppMenusExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetAppMenusExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<AppMenuEntity>, any>(["*abac.AppMenuEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetAppMenusExport.UKEY = "*abac.AppMenuEntity"