...
import { execApiFn, type IResponseList } from "../../core/http-tools";
    import {
        WorkspaceRoleEntity,
    } from "../abac/WorkspaceRoleEntity"
// Fireback gives the option to have typesafe query string
export type GetWorkspaceRolesExportQs = {
}
export type GetWorkspaceRolesExportUrlParams = {
}
export type GetWorkspaceRolesExportHeaders = {
}
export function useGetWorkspaceRolesExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspaceRolesExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<WorkspaceRoleEntity>, any>(["*abac.WorkspaceRoleEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetWorkspaceRolesExport.UKEY = "*abac.WorkspaceRoleEntity"