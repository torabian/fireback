...
export type GetWorkspaceInvitesQs = {
}
export type GetWorkspaceInvitesUrlParams = {
}
export type GetWorkspaceInvitesHeaders = {
}
export function useGetWorkspaceInvites({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetWorkspaceInvitesQs}) {
...
useGetWorkspaceInvites.UKEY = "*abac.WorkspaceInviteEntity"