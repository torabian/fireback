...
export type GetCapabilitiesExportQs = {
}
export type GetCapabilitiesExportUrlParams = {
}
export type GetCapabilitiesExportHeaders = {
}
export function useGetCapabilitiesExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetCapabilitiesExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<CapabilityEntity>, any>(["*fireback.CapabilityEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetCapabilitiesExport.UKEY = "*fireback.CapabilityEntity"