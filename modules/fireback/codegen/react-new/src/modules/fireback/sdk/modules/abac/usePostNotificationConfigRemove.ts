...
import {
  ...
  queryBeforeSend,
    ...
    import {
        DeleteRequestDto,
    } from "../fireback/DeleteRequestDto"
    import {
        DeleteResponseDto,
    } from "../fireback/DeleteResponseDto"
export function usePostNotificationConfigRemove(
  ...
  const url = "/notification-config-remove".substr(1);
