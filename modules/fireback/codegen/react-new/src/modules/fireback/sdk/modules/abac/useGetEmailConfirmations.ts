...
export type GetEmailConfirmationsQs = {
}
export type GetEmailConfirmationsUrlParams = {
}
export type GetEmailConfirmationsHeaders = {
}
export function useGetEmailConfirmations({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetEmailConfirmationsQs}) {
...
useGetEmailConfirmations.UKEY = "*abac.EmailConfirmationEntity"