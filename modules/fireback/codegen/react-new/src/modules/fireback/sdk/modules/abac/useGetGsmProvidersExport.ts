...
import { execApiFn, IResponseList } from "../../core/http-tools";
    import {
        GsmProviderEntity,
    } from "../abac/GsmProviderEntity"
// Fireback gives the option to have typesafe query string
export type GetGsmProvidersExportQs = {
}
export type GetGsmProvidersExportUrlParams = {
}
export type GetGsmProvidersExportHeaders = {
}
export function useGetGsmProvidersExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetGsmProvidersExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<GsmProviderEntity>, any>(["*abac.GsmProviderEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetGsmProvidersExport.UKEY = "*abac.GsmProviderEntity"