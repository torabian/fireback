...
import { execApiFn, type IResponseList } from "../../core/http-tools";
    import {
        EmailSenderEntity,
    } from "../abac/EmailSenderEntity"
// Fireback gives the option to have typesafe query string
export type GetEmailSendersExportQs = {
}
export type GetEmailSendersExportUrlParams = {
}
export type GetEmailSendersExportHeaders = {
}
export function useGetEmailSendersExport({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetEmailSendersExportQs}) {
  ...
  const query$ = useQuery<any, any, IResponseList<EmailSenderEntity>, any>(["*abac.EmailSenderEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetEmailSendersExport.UKEY = "*abac.EmailSenderEntity"