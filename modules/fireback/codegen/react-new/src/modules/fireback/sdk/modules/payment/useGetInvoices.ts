...
export type GetInvoicesQs = {
}
export type GetInvoicesUrlParams = {
}
export type GetInvoicesHeaders = {
}
export function useGetInvoices({
  ...
  unauthorized,
  optionFn
}: UseRemoteQuery & {query?: GetInvoicesQs}) {
...
useGetInvoices.UKEY = "*payment.InvoiceEntity"