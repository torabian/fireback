import {Context as C} from '@/modules/fireback/definitions/definitions';
import {withJsonQuery} from './withJsonQuery';
import {RemoteRequestOption} from '../sdk/core/http-tools';
...
export const mockExecFn = (
  ...
  return function (method: string, url: string, body: any) {
    ...
    return Promise.reject({
      error: {
        message: 'Not available on mock:' + '(' + method + ' on ' + url + ')',
      },
    });
  };
};
