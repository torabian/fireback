...
export class WebRequestX extends BaseRequest {
    ...
    getFetchOptions(overrideFetchParams = null) {
        ...
        return Object.assign(Object.assign({}, options), (overrideFetchParams || {}));
    }
    /**
    ...
    exec(overrideUrl = null, overrideFetchParams = null) {
        return fetch(this.getComputedUrl(overrideUrl), this.getFetchOptions(overrideFetchParams)).then((res) => __awaiter(this, void 0, void 0, function* () {
            let parsed;
