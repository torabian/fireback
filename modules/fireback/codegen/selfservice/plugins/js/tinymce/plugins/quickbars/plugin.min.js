...
!(function () {
  ...
  class h {
    ...
    map(t) {
      return this.tag ? h.some(t(this.value)) : h.none();
    }
    bind(t) {
      return this.tag ? t(this.value) : h.none();
    }
    exists(t) {
    ...
    filter(t) {
      return !this.tag || t(this.value) ? this : h.none();
    }
    getOr(t) {
  ...
  var g = (t, e, o, n, i) =>
    t(o, n) ? h.some(o) : r(i) && i(o) ? h.none() : e(o, n, i);
  const b = (t) => {
        ...
        t.ui.registry.addContextToolbar("quickblock", {
          predicate: (e) => {
            ...
            return (
              ...
              ((t, e, o) =>
                g((t, e) => f(t, e), y, t, 'table,[data-mce-bogus="all"]', o))(
                o,
                0,
                r
              ).fold(
