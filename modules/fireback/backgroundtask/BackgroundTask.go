...
// This file has not been used, but it's quite useful. The problem is query dsl is there.
// import (
// 	"bufio"
// 	"context"
// 	"fmt"
...
// 	Done      chan bool
// 	Read      chan socket.SocketReadChan
// 	Listeners []func([]byte)
// 	Group     string
// }
...
// func (x *BackgroundReactiveProcess) Send(v socket.SocketReadChan) {
// 	x.Read <- v
// }
