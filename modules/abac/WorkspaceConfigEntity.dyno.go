...
type WorkspaceConfigEntity struct {
	...
	EnableRecaptcha2 workspaces.Bool `json:"enableRecaptcha2" yaml:"enableRecaptcha2"        `
	// Enables the otp option. It's not forcing it, so user can choose if they want otp or password.
	EnableOtp workspaces.Bool `json:"enableOtp" yaml:"enableOtp"        `
	// Forces the user to have otp verification before can create an account. They can define their password still.
	RequireOtpOnSignup workspaces.Bool `json:"requireOtpOnSignup" yaml:"requireOtpOnSignup"        `
	...
	RequireOtpOnSignin workspaces.Bool `json:"requireOtpOnSignin" yaml:"requireOtpOnSignin"        `
