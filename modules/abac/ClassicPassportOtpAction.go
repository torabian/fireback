...
func (x *ClassicPassportOtpActionResponse) AsIdeal() (*ClassicPassportOtpActionRes, error) {
	b, err := json.Marshal(x.GetPayload())
	if err != nil {
		return nil, err
	}
	var res ClassicPassportOtpActionRes
...
func (x ClassicPassportOtpActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}

// Returns the urfave 3 cli context. You need to manullay cast to .(*cli.Command)
func (x ClassicPassportOtpActionRequest) GetCliCtx() interface{} {
	return x.CliCtx
}
