...
type WorkspaceInviteOptionalDto struct {
	...
	PublicKey emigo.Nullable[string] `json:"publicKey" yaml:"publicKey"`
	...
	TargetUserLocale emigo.Nullable[string] `json:"targetUserLocale" yaml:"targetUserLocale"`
...
func (x *WorkspaceInviteOptionalDto) Json() string {
	if x != nil {
...
func GetWorkspaceInviteOptionalDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWorkspaceInviteOptionalDtoFromCli(c emigo.CliCastable) WorkspaceInviteOptionalDto {
	data := WorkspaceInviteOptionalDto{}
	if c.IsSet("unique-id") {
		emigo.ParseNullable(c.String("unique-id"), &data.UniqueId)
	}
	if c.IsSet("public-key") {
		emigo.ParseNullable(c.String("public-key"), &data.PublicKey)
	}
	if c.IsSet("cover-letter") {
		emigo.ParseNullable(c.String("cover-letter"), &data.CoverLetter)
	}
	if c.IsSet("target-user-locale") {
		emigo.ParseNullable(c.String("target-user-locale"), &data.TargetUserLocale)
	}
	if c.IsSet("email") {
		emigo.ParseNullable(c.String("email"), &data.Email)
	}
	if c.IsSet("phonenumber") {
		emigo.ParseNullable(c.String("phonenumber"), &data.Phonenumber)
	}
