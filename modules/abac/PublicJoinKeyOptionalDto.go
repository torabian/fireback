...
type PublicJoinKeyOptionalDto struct {
...
func (x *PublicJoinKeyOptionalDto) Json() string {
	if x != nil {
...
func GetPublicJoinKeyOptionalDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastPublicJoinKeyOptionalDtoFromCli(c emigo.CliCastable) PublicJoinKeyOptionalDto {
	data := PublicJoinKeyOptionalDto{}
