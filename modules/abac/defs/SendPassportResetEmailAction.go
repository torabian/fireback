...
func GetSendPassportResetEmailActionResCliFlags(prefix string) []emigo.CliFlag {
	return []emigo.CliFlag{
		{
			Name: prefix + "sent",
			Type: "bool",
...
func CastSendPassportResetEmailActionResFromCli(c emigo.CliCastable) SendPassportResetEmailActionRes {
	data := SendPassportResetEmailActionRes{}
	if c.IsSet("sent") {
		data.Sent = bool(c.Bool("sent"))
	}
	return data
}
...
// SendPassportResetEmailActionRaw registers a raw Gin route for the SendPassportResetEmailAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func SendPassportResetEmailActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := SendPassportResetEmailActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// SendPassportResetEmailActionHandler returns the HTTP method, route URL, and a typed Gin handler for the SendPassportResetEmailAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func SendPassportResetEmailActionHandler(
...
// SendPassportResetEmailActionGin is a high-level convenience wrapper around SendPassportResetEmailActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func SendPassportResetEmailActionGin(r gin.IRoutes, handler func(c SendPassportResetEmailActionRequest) (*SendPassportResetEmailActionResponse, error)) {
	method, url, h := SendPassportResetEmailActionHandler(handler)
	r.Handle(method, url, h)
}
func (x SendPassportResetEmailActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func SendPassportResetEmailActionQueryFromGin(c *gin.Context) SendPassportResetEmailActionQuery {
	return SendPassportResetEmailActionQueryFromString(c.Request.URL.RawQuery)
}
