...
type WorkspaceConfigOptionalDto struct {
	...
	Recaptcha2ServerKey emigo.Nullable[string] `json:"recaptcha2ServerKey" yaml:"recaptcha2ServerKey"`
	...
	Recaptcha2ClientKey emigo.Nullable[string] `json:"recaptcha2ClientKey" yaml:"recaptcha2ClientKey"`
...
func (x *WorkspaceConfigOptionalDto) Json() string {
	if x != nil {
