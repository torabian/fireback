...
func GetWorkspaceRoleOptionalDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWorkspaceRoleOptionalDtoFromCli(c emigo.CliCastable) WorkspaceRoleOptionalDto {
	data := WorkspaceRoleOptionalDto{}
