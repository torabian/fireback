...
func (x *WorkspaceRoleDto) Json() string {
	if x != nil {
...
func GetWorkspaceRoleDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWorkspaceRoleDtoFromCli(c emigo.CliCastable) WorkspaceRoleDto {
