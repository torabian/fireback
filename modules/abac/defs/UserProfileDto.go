...
func (x *UserProfileDto) Json() string {
	if x != nil {
...
func GetUserProfileDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastUserProfileDtoFromCli(c emigo.CliCastable) UserProfileDto {
	data := UserProfileDto{}
