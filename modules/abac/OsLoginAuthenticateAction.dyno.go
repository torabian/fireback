...
func (x *OsLoginAuthenticateActionResponse) WithIdeal(payload UserSessionDto) *OsLoginAuthenticateActionResponse {
	x.Payload = payload
	return x
}

// Use this for client calls, so the payload is being casted
func (x *OsLoginAuthenticateActionResponse) AsIdeal() (*UserSessionDto, error) {
	b, err := json.Marshal(x.GetPayload())
	if err != nil {
		return nil, err
	}
	var res UserSessionDto
...
// OsLoginAuthenticateActionGin is a high-level convenience wrapper around OsLoginAuthenticateActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func OsLoginAuthenticateActionGin(r gin.IRoutes, handler func(c OsLoginAuthenticateActionRequest) (*OsLoginAuthenticateActionResponse, error)) {
...
// returns either an *OsLoginAuthenticateActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func OsLoginAuthenticateActionHttpHandler(
	handler func(c OsLoginAuthenticateActionRequest) (*OsLoginAuthenticateActionResponse, error),
...
// OsLoginAuthenticateActionHttp is a high-level convenience wrapper around
// OsLoginAuthenticateActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func OsLoginAuthenticateActionHttp(
	mux *http.ServeMux,
	handler func(c OsLoginAuthenticateActionRequest) (*OsLoginAuthenticateActionResponse, error),
) {
	method, pattern, h := OsLoginAuthenticateActionHttpHandler(handler)
