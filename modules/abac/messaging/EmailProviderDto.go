...
func (x *EmailProviderDto) Json() string {
	if x != nil {
...
func GetEmailProviderDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastEmailProviderDtoFromCli(c emigo.CliCastable) EmailProviderDto {
