...
func (x *WebPushConfigDto) Json() string {
	if x != nil {
...
func GetWebPushConfigDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWebPushConfigDtoFromCli(c emigo.CliCastable) WebPushConfigDto {
	data := WebPushConfigDto{}
