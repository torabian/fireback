...
type MessagingConfigOptionalDto struct {
...
func (x *MessagingConfigOptionalDto) Json() string {
	if x != nil {
...
func GetMessagingConfigOptionalDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastMessagingConfigOptionalDtoFromCli(c emigo.CliCastable) MessagingConfigOptionalDto {
	data := MessagingConfigOptionalDto{}
