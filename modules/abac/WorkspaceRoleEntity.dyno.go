...
type WorkspaceRoleEntity struct {
	...
	UserWorkspaceId  workspaces.String      `json:"userWorkspaceId" yaml:"userWorkspaceId" gorm:"index:workspacerole_idx,unique" `
	Role             *RoleEntity            `json:"role" yaml:"role"    gorm:"foreignKey:RoleId;references:UniqueId"      `
	RoleId           workspaces.String      `json:"roleId" yaml:"roleId" gorm:"index:workspacerole_idx,unique" `
