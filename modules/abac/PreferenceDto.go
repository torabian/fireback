...
func (x *PreferenceDto) Json() string {
	if x != nil {
...
func GetPreferenceDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastPreferenceDtoFromCli(c emigo.CliCastable) PreferenceDto {
	data := PreferenceDto{}
