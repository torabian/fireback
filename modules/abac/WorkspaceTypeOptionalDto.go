...
type WorkspaceTypeOptionalDto struct {
	...
	Slug        emigo.Nullable[string] `json:"slug" yaml:"slug"`
...
func GetWorkspaceTypeOptionalDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWorkspaceTypeOptionalDtoFromCli(c emigo.CliCastable) WorkspaceTypeOptionalDto {
	data := WorkspaceTypeOptionalDto{}
	...
	if c.IsSet("slug") {
		emigo.ParseNullable(c.String("slug"), &data.Slug)
	}
	if c.IsSet("role-id") {
