...
func NotificationConfigGetActionMeta() struct {
	...
	return struct {
		...
		CliName:     "notification-config-get-action",
...
func NotificationConfigGetActionPathParameterFromGin(g *gin.Context) NotificationConfigGetActionPathParameter {
	return NotificationConfigGetActionPathParameterFromFn(func(key string) string {
		return g.Param(key)
	})
}

// NotificationConfigGetActionRaw registers a raw Gin route for the NotificationConfigGetAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func NotificationConfigGetActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := NotificationConfigGetActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// NotificationConfigGetActionHandler returns the HTTP method, route URL, and a typed Gin handler for the NotificationConfigGetAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func NotificationConfigGetActionHandler(
	...
	return meta.Method, meta.URL, func(m *gin.Context) {
		...
		req := NotificationConfigGetActionRequest{
			Body:        nil,
			Params:      NotificationConfigGetActionPathParameterFromGin(m),
...
// NotificationConfigGetActionGin is a high-level convenience wrapper around NotificationConfigGetActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func NotificationConfigGetActionGin(r gin.IRoutes, handler func(c NotificationConfigGetActionRequest) (*NotificationConfigGetActionResponse, error)) {
	method, url, h := NotificationConfigGetActionHandler(handler)
	r.Handle(method, url, h)
}
func (x NotificationConfigGetActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func NotificationConfigGetActionQueryFromGin(c *gin.Context) NotificationConfigGetActionQuery {
	return NotificationConfigGetActionQueryFromString(c.Request.URL.RawQuery)
}
