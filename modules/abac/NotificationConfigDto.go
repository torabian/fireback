...
type NotificationConfigDto struct {
	...
	InviteToWorkspaceContentDefault        string                  `json:"inviteToWorkspaceContentDefault" yaml:"inviteToWorkspaceContentDefault"`
	InviteToWorkspaceContentDefaultExcerpt string                  `json:"inviteToWorkspaceContentDefaultExcerpt" yaml:"inviteToWorkspaceContentDefaultExcerpt"`
	InviteToWorkspaceTitle                 string                  `json:"inviteToWorkspaceTitle" yaml:"inviteToWorkspaceTitle"`
	InviteToWorkspaceTitleDefault          string                  `json:"inviteToWorkspaceTitleDefault" yaml:"inviteToWorkspaceTitleDefault"`
	...
	ForgetPasswordContentDefault           string                  `json:"forgetPasswordContentDefault" yaml:"forgetPasswordContentDefault"`
	ForgetPasswordContentDefaultExcerpt    string                  `json:"forgetPasswordContentDefaultExcerpt" yaml:"forgetPasswordContentDefaultExcerpt"`
	ForgetPasswordTitle                    string                  `json:"forgetPasswordTitle" yaml:"forgetPasswordTitle"`
	ForgetPasswordTitleDefault             string                  `json:"forgetPasswordTitleDefault" yaml:"forgetPasswordTitleDefault"`
	...
	ConfirmEmailContentDefault             string                  `json:"confirmEmailContentDefault" yaml:"confirmEmailContentDefault"`
	ConfirmEmailContentDefaultExcerpt      string                  `json:"confirmEmailContentDefaultExcerpt" yaml:"confirmEmailContentDefaultExcerpt"`
	ConfirmEmailTitle                      string                  `json:"confirmEmailTitle" yaml:"confirmEmailTitle"`
	ConfirmEmailTitleDefault               string                  `json:"confirmEmailTitleDefault" yaml:"confirmEmailTitleDefault"`
