...
func UserWorkspaceGetActionPathParameterFromGin(g *gin.Context) UserWorkspaceGetActionPathParameter {
	return UserWorkspaceGetActionPathParameterFromFn(func(key string) string {
		return g.Param(key)
	})
}

// UserWorkspaceGetActionRaw registers a raw Gin route for the UserWorkspaceGetAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func UserWorkspaceGetActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := UserWorkspaceGetActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// UserWorkspaceGetActionHandler returns the HTTP method, route URL, and a typed Gin handler for the UserWorkspaceGetAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func UserWorkspaceGetActionHandler(
	...
	return meta.Method, meta.URL, func(m *gin.Context) {
		...
		req := UserWorkspaceGetActionRequest{
			Body:        nil,
			Params:      UserWorkspaceGetActionPathParameterFromGin(m),
...
// UserWorkspaceGetActionGin is a high-level convenience wrapper around UserWorkspaceGetActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func UserWorkspaceGetActionGin(r gin.IRoutes, handler func(c UserWorkspaceGetActionRequest) (*UserWorkspaceGetActionResponse, error)) {
	method, url, h := UserWorkspaceGetActionHandler(handler)
	r.Handle(method, url, h)
}
func (x UserWorkspaceGetActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func UserWorkspaceGetActionQueryFromGin(c *gin.Context) UserWorkspaceGetActionQuery {
	return UserWorkspaceGetActionQueryFromString(c.Request.URL.RawQuery)
}
func GetUserWorkspaceGetActionPathParameterCliFlags(prefix string) []emigo.CliFlag {
...
func UserWorkspaceGetActionPathParameterFromCli(c *cli.Command) UserWorkspaceGetActionPathParameter {
	return UserWorkspaceGetActionPathParameterFromFn(func(key string) string {
...
func (x UserWorkspaceGetActionRequest) IsCli() bool {
	if x.CliCtx == nil {
		return false
	}
...
// UserWorkspaceGetActionCliFlags returns every flag (request body, path parameters,
// query parameters and typed headers) the UserWorkspaceGetAction action can bind from
// urfave v3, plus a generic repeatable --header/-H flag for anything not covered by a
// typed header.
func UserWorkspaceGetActionCliFlags() []cli.Flag {
	flags := []cli.Flag{
		&cli.StringSliceFlag{
			Name:    "header",
			Aliases: []string{"H"},
	...
	flags = append(flags, emigo.CastEmiFlagToUrfave(GetUserWorkspaceGetActionPathParameterCliFlags(""))...)
	return flags
}

// UserWorkspaceGetActionCliHandler builds a full *cli.Command for the
// UserWorkspaceGetAction action: it wires body, path parameters, query parameters and
// headers from urfave v3 CLI flags into a UserWorkspaceGetActionRequest the same way
// UserWorkspaceGetActionHandler (Gin) and UserWorkspaceGetActionHttpHandler (net/http)
// do from their own transports, then prints the JSON response (or returns the error) so
// urfave reports the right exit code.
func UserWorkspaceGetActionCliHandler(
	handler func(c UserWorkspaceGetActionRequest) (*UserWorkspaceGetActionResponse, error),
) *cli.Command {
	meta := UserWorkspaceGetActionMeta()
	cmd := &cli.Command{
		...
		Flags: UserWorkspaceGetActionCliFlags(),
	}
	...
	cmd.Action = func(ctx context.Context, c *cli.Command) error {
		req := UserWorkspaceGetActionRequest{
			...
			Params:      UserWorkspaceGetActionPathParameterFromCli(c),
		}
...
// UserWorkspaceGetActionCli is a high-level convenience wrapper around
// UserWorkspaceGetActionCliHandler. It registers the generated command as a subcommand
// of an existing urfave v3 *cli.Command, the same way UserWorkspaceGetActionGin
// registers a route on a Gin engine.
func UserWorkspaceGetActionCli(
	app *cli.Command,
	handler func(c UserWorkspaceGetActionRequest) (*UserWorkspaceGetActionResponse, error),
) {
	app.Commands = append(app.Commands, UserWorkspaceGetActionCliHandler(handler))
}
