...
func PassportCreateActionMeta() struct {
	...
	return struct {
		...
		CliName:     "passport-create-action",
		CliShort:    "passport-c",
		URL:         "/passport",
		Method:      "POST",
...
// PassportCreateActionRaw registers a raw Gin route for the PassportCreateAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func PassportCreateActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := PassportCreateActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// PassportCreateActionHandler returns the HTTP method, route URL, and a typed Gin handler for the PassportCreateAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func PassportCreateActionHandler(
...
// PassportCreateActionGin is a high-level convenience wrapper around PassportCreateActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func PassportCreateActionGin(r gin.IRoutes, handler func(c PassportCreateActionRequest) (*PassportCreateActionResponse, error)) {
	method, url, h := PassportCreateActionHandler(handler)
	r.Handle(method, url, h)
}
func (x PassportCreateActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func PassportCreateActionQueryFromGin(c *gin.Context) PassportCreateActionQuery {
	return PassportCreateActionQueryFromString(c.Request.URL.RawQuery)
}
