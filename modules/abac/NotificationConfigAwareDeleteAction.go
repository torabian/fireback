...
func NotificationConfigAwareDeleteActionMeta() struct {
	...
	return struct {
		...
		CliName:     "notification-config-aware-delete-action",
...
// NotificationConfigAwareDeleteActionRaw registers a raw Gin route for the NotificationConfigAwareDeleteAction action.
// This gives the developer full control over middleware, handlers, and response handling.
func NotificationConfigAwareDeleteActionRaw(r *gin.Engine, handlers ...gin.HandlerFunc) {
	meta := NotificationConfigAwareDeleteActionMeta()
	r.Handle(meta.Method, meta.URL, handlers...)
}

// NotificationConfigAwareDeleteActionHandler returns the HTTP method, route URL, and a typed Gin handler for the NotificationConfigAwareDeleteAction action.
// Developers implement their business logic as a function that receives a typed request object
// and returns either an *ActionResponse or nil. JSON marshalling, headers, and errors are handled automatically.
func NotificationConfigAwareDeleteActionHandler(
...
// NotificationConfigAwareDeleteActionGin is a high-level convenience wrapper around NotificationConfigAwareDeleteActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func NotificationConfigAwareDeleteActionGin(r gin.IRoutes, handler func(c NotificationConfigAwareDeleteActionRequest) (*NotificationConfigAwareDeleteActionResponse, error)) {
	method, url, h := NotificationConfigAwareDeleteActionHandler(handler)
	r.Handle(method, url, h)
}
func (x NotificationConfigAwareDeleteActionRequest) IsGin() bool {
	if x.GinCtx == nil {
		return false
	}
...
func NotificationConfigAwareDeleteActionQueryFromGin(c *gin.Context) NotificationConfigAwareDeleteActionQuery {
	return NotificationConfigAwareDeleteActionQueryFromString(c.Request.URL.RawQuery)
}
