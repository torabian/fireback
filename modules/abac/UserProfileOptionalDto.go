...
func GetUserProfileOptionalDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastUserProfileOptionalDtoFromCli(c emigo.CliCastable) UserProfileOptionalDto {
	data := UserProfileOptionalDto{}
