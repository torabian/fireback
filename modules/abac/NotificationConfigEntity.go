...
func init() {
	...
	/*
		NotificationConfigActions.Create = func(dto *NotificationConfigEntity, query QueryDSL) (*NotificationConfigEntity, *IError) {
			// Do something before hand
			result, err := NotificationConfigActionCreateFn(dto, query)
