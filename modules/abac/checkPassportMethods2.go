...
func CheckPassportMethods2ActionMeta() struct {
	...
	return struct {
		...
		URL:     "/v2/passports/available-methods",
		Method:  "GET",
	}
}
...
func CheckPassportMethods2ActionHandler(
	handler func(c CheckPassportMethods2ActionRequest, gin *gin.Context) (*CheckPassportMethods2ActionResponse, error),
...
func CheckPassportMethods2Action(r gin.IRoutes, handler func(c CheckPassportMethods2ActionRequest, gin *gin.Context) (*CheckPassportMethods2ActionResponse, error)) {
