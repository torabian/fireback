...
func (x SendEmailActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}
...
// SendEmailActionGin is a high-level convenience wrapper around SendEmailActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func SendEmailActionGin(r gin.IRoutes, handler func(c SendEmailActionRequest) (*SendEmailActionResponse, error)) {
...
// returns either an *SendEmailActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func SendEmailActionHttpHandler(
	handler func(c SendEmailActionRequest) (*SendEmailActionResponse, error),
...
// SendEmailActionHttp is a high-level convenience wrapper around
// SendEmailActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func SendEmailActionHttp(
	mux *http.ServeMux,
	handler func(c SendEmailActionRequest) (*SendEmailActionResponse, error),
) {
	method, pattern, h := SendEmailActionHttpHandler(handler)
