...
func (x QueryWorkspaceTypesPubliclyActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}
...
// QueryWorkspaceTypesPubliclyActionGin is a high-level convenience wrapper around QueryWorkspaceTypesPubliclyActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func QueryWorkspaceTypesPubliclyActionGin(r gin.IRoutes, handler func(c QueryWorkspaceTypesPubliclyActionRequest) (*QueryWorkspaceTypesPubliclyActionResponse, error)) {
...
// typed net/http handler for the QueryWorkspaceTypesPubliclyAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *QueryWorkspaceTypesPubliclyActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func QueryWorkspaceTypesPubliclyActionHttpHandler(
	handler func(c QueryWorkspaceTypesPubliclyActionRequest) (*QueryWorkspaceTypesPubliclyActionResponse, error),
...
// QueryWorkspaceTypesPubliclyActionHttp is a high-level convenience wrapper around
// QueryWorkspaceTypesPubliclyActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func QueryWorkspaceTypesPubliclyActionHttp(
	mux *http.ServeMux,
	handler func(c QueryWorkspaceTypesPubliclyActionRequest) (*QueryWorkspaceTypesPubliclyActionResponse, error),
) {
	method, pattern, h := QueryWorkspaceTypesPubliclyActionHttpHandler(handler)
