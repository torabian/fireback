...
type UserWorkspaceEntity struct {
	...
	WorkspaceId fireback.String `json:"workspaceId,omitempty" xml:"workspaceId,omitempty" yaml:"workspaceId,omitempty" gorm:"index:userworkspace_idx,unique" `
	...
	UserId fireback.String `json:"userId,omitempty" xml:"userId,omitempty" yaml:"userId,omitempty" gorm:"index:userworkspace_idx,unique" `
...
func (x *UserWorkspaceEntityList) ToTree() *fireback.TreeOperation[UserWorkspaceEntity] {
...
type userWorkspaceActionsSig struct {
	Update         func(query fireback.QueryDSL, dto *UserWorkspaceEntity) (*UserWorkspaceEntity, *fireback.IError)
	Create         func(dto *UserWorkspaceEntity, query fireback.QueryDSL) (*UserWorkspaceEntity, *fireback.IError)
	Upsert         func(dto *UserWorkspaceEntity, query fireback.QueryDSL) (*UserWorkspaceEntity, *fireback.IError)
...
func UserWorkspaceActionUpsertFn(dto *UserWorkspaceEntity, query fireback.QueryDSL) (*UserWorkspaceEntity, *fireback.IError) {
	return nil, nil
}
...
type UserWorkspaceFieldMap struct {
	...
	UserPermissions      fireback.TranslatedString `yaml:"userPermissions"`
	RolePermission       fireback.TranslatedString `yaml:"rolePermission"`
	WorkspacePermissions fireback.TranslatedString `yaml:"workspacePermissions"`
}

var UserWorkspaceEntityMetaConfig map[string]int64 = map[string]int64{}
var UserWorkspaceEntityJsonSchema = fireback.ExtractEntityFields(reflect.ValueOf(&UserWorkspaceEntity{}))

func entityUserWorkspaceFormatter(dto *UserWorkspaceEntity, query fireback.QueryDSL) {
	if dto == nil {
		return
	}
}
func UserWorkspaceActionSeederMultiple(query fireback.QueryDSL, count int) {
	successInsert := 0
	failureInsert := 0
	batchSize := 100
...
func UserWorkspaceActionSeeder(query fireback.QueryDSL, count int) {
	successInsert := 0
	failureInsert := 0
	bar := progressbar.Default(int64(count))
	for i := 1; i <= count; i++ {
...
func UserWorkspaceAssociationCreate(dto *UserWorkspaceEntity, query fireback.QueryDSL) error {
	return nil
}
...
**/
func UserWorkspaceRelationContentCreate(dto *UserWorkspaceEntity, query fireback.QueryDSL) error {
	return nil
}
func UserWorkspaceRelationContentUpdate(dto *UserWorkspaceEntity, query fireback.QueryDSL) error {
	return nil
}
func UserWorkspacePolyglotUpdateHandler(dto *UserWorkspaceEntity, query fireback.QueryDSL) {
	if dto == nil {
		return
	}
}
 ...
 */
func UserWorkspaceValidator(dto *UserWorkspaceEntity, isPatch bool) *fireback.IError {
...
func UserWorkspaceEntityPreSanitize(dto *UserWorkspaceEntity, query fireback.QueryDSL) {
}
func UserWorkspaceEntityBeforeCreateAppend(dto *UserWorkspaceEntity, query fireback.QueryDSL) {
	if dto.UniqueId == "" {
...
func UserWorkspaceRecursiveAddUniqueId(dto *UserWorkspaceEntity, query fireback.QueryDSL) {
}
...
func UserWorkspaceActionBatchCreateFn(dtos []*UserWorkspaceEntity, query fireback.QueryDSL) ([]*UserWorkspaceEntity, *fireback.IError) {
...
func UserWorkspaceDeleteEntireChildren(query fireback.QueryDSL, dto *UserWorkspaceEntity) *fireback.IError {
	// intentionally removed this. It's hard to implement it, and probably wrong without
	// proper on delete cascade
	return nil
}
func UserWorkspaceActionCreateFn(dto *UserWorkspaceEntity, query fireback.QueryDSL) (*UserWorkspaceEntity, *fireback.IError) {
	// 1. Validate always
	...
	/*
		event.MustFire(USER_WORKSPACE_EVENT_CREATED, event.M{
			"entity":   dto,
			"entityKey": fireback.GetTypeString(&UserWorkspaceEntity{}),
			"target":   "workspace",
...
func UserWorkspaceActionGetOneFn(query fireback.QueryDSL) (*UserWorkspaceEntity, *fireback.IError) {
	refl := reflect.ValueOf(&UserWorkspaceEntity{})
	item, err := fireback.GetOneEntity[UserWorkspaceEntity](query, refl)
	entityUserWorkspaceFormatter(item, query)
	return item, err
}
func UserWorkspaceActionGetByWorkspaceFn(query fireback.QueryDSL) (*UserWorkspaceEntity, *fireback.IError) {
	refl := reflect.ValueOf(&UserWorkspaceEntity{})
	item, err := fireback.GetOneByWorkspaceEntity[UserWorkspaceEntity](query, refl)
	entityUserWorkspaceFormatter(item, query)
	return item, err
}
...
func UserWorkspaceUpdateExec(dbref *gorm.DB, query fireback.QueryDSL, fields *UserWorkspaceEntity) (*UserWorkspaceEntity, *fireback.IError) {
...
func UserWorkspaceActionUpdateFn(query fireback.QueryDSL, fields *UserWorkspaceEntity) (*UserWorkspaceEntity, *fireback.IError) {
	if fields == nil {
...
func UserWorkspaceActionRemoveFn(query fireback.QueryDSL) (int64, *fireback.IError) {
	refl := reflect.ValueOf(&UserWorkspaceEntity{})
	query.ActionRequires = []fireback.PermissionInfo{PERM_ROOT_USER_WORKSPACE_DELETE}
	return fireback.RemoveEntity[UserWorkspaceEntity](query, refl)
}
func UserWorkspaceActionWipeClean(query fireback.QueryDSL) (int64, error) {
	var err error
	var count int64 = 0
	{
		subCount, subErr := fireback.WipeCleanEntity[UserWorkspaceEntity]()
		if subErr != nil {
...
func UserWorkspaceActionBulkUpdate(
	query fireback.QueryDSL, dto *fireback.BulkRecordRequest[UserWorkspaceEntity]) (
	*fireback.BulkRecordRequest[UserWorkspaceEntity], *fireback.IError,
) {
...
var UserWorkspaceEntityMeta = fireback.TableMetaData{
...
func UserWorkspaceActionExport(
	...
	return fireback.YamlExporterChannel[UserWorkspaceEntity](query, UserWorkspaceActions.Query, UserWorkspacePreloadRelations)
}
func UserWorkspaceActionExportT(
	query fireback.QueryDSL,
) (chan []interface{}, *fireback.IError) {
	return fireback.YamlExporterChannelT[UserWorkspaceEntity](query, UserWorkspaceActions.Query, UserWorkspacePreloadRelations)
}
...
var UserWorkspaceCreateInteractiveCmd cli.Command = cli.Command{
	...
	Action: func(c *cli.Context) {
		...
		entity := &UserWorkspaceEntity{}
		fireback.PopulateInteractively(entity, c, UserWorkspaceCommonInteractiveCliFlags)
...
func UserWorkspaceSyncSeederFromFs(fsRef *embed.FS, fileNames []string, q fireback.QueryDSL) {
...
func UserWorkspaceWriteQueryMock(ctx fireback.MockQueryContext) {
...
var UserWorkspaceImportExportCommands = []cli.Command{
	...
	cli.Command{
		...
		Action: func(c *cli.Context) error {
			if entity, err := fireback.GetSeederFilenames(userWorkspaceSeedersFs, ""); err != nil {
				fmt.Println(err.Error())
			} else {
				f, _ := json.MarshalIndent(entity, "", "  ")
				fmt.Println(string(f))
...
var USER_WORKSPACE_ACTION_TABLE = fireback.Module3Action{
	Name:          "table",
...
var USER_WORKSPACE_ACTION_QUERY = fireback.Module3Action{
	Method: "GET",
	Url:    "/user-workspaces",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires:  []fireback.PermissionInfo{PERM_ROOT_USER_WORKSPACE_QUERY},
		ResolveStrategy: "user",
	},
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			qs := &UserWorkspaceEntityQs{}
			fireback.HttpQueryEntity(c, UserWorkspaceActions.Query, qs)
		},
	},
	Format:         "QUERY",
	Action:         UserWorkspaceActions.Query,
	...
	Flags:         append(fireback.CommonQueryFlags, UserWorkspaceQsFlags...),
	Description:   "Queries all of the entities in database based on the standard query format (s+)",
}
var USER_WORKSPACE_ACTION_EXPORT = fireback.Module3Action{
	Method: "GET",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpStreamFileChannel(c, UserWorkspaceActionExport)
		},
	},
	Format:         "QUERY",
...
var USER_WORKSPACE_ACTION_GET_ONE = fireback.Module3Action{
	Method: "GET",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpGetEntity(c, UserWorkspaceActions.GetOne)
		},
	},
	Format:         "GET_ONE",
...
var USER_WORKSPACE_ACTION_POST_ONE = fireback.Module3Action{
	Name:          "create",
...
var USER_WORKSPACE_ACTION_PATCH = fireback.Module3Action{
	Name:          "update",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpUpdateEntity(c, UserWorkspaceActions.Update)
		},
	},
...
var USER_WORKSPACE_ACTION_PATCH_BULK = fireback.Module3Action{
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpUpdateEntities(c, UserWorkspaceActionBulkUpdate)
		},
	},
	Action:         UserWorkspaceActionBulkUpdate,
	Format:         "PATCH_BULK",
	RequestEntity:  &fireback.BulkRecordRequest[UserWorkspaceEntity]{},
	ResponseEntity: &fireback.BulkRecordRequest[UserWorkspaceEntity]{},
	Out: &fireback.Module3ActionBody{
		Entity: "UserWorkspaceEntity",
	},
	In: &fireback.Module3ActionBody{
...
var USER_WORKSPACE_ACTION_DELETE = fireback.Module3Action{
	Method: "DELETE",
	Url:    "/user-workspace",
	Format: "DELETE_DSL",
	SecurityModel: &fireback.SecurityModel{
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpRemoveEntity(c, UserWorkspaceActions.Remove)
		},
	},
 ...
 **/
var AppendUserWorkspaceRouter = func(r *[]fireback.Module3Action) {}

func GetUserWorkspaceModule3Actions() []fireback.Module3Action {
...
var UserWorkspaceEntityBundle = fireback.EntityBundle{
