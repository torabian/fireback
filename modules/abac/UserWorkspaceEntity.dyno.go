...
type UserWorkspaceEntity struct {
	...
	WorkspaceId emigo.Nullable[string] `json:"workspaceId,omitempty" xml:"workspaceId,omitempty" yaml:"workspaceId,omitempty" gorm:"index:userworkspace_idx,unique" `
	...
	UserId emigo.Nullable[string] `json:"userId,omitempty" xml:"userId,omitempty" yaml:"userId,omitempty" gorm:"index:userworkspace_idx,unique" `
...
func CastUserWorkspaceFromCli(c *cli.Command) *UserWorkspaceEntity {
	...
	if c.IsSet("workspace-id") {
		template.WorkspaceId = emigo.NullableOf(c.String("workspace-id"))
	}
	return template
}
