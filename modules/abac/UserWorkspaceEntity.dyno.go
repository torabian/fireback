...
type UserWorkspaceEntityQs struct {
	User                 workspaces.QueriableField `cli:"user" table:"user_workspace" column:"user" qs:"user"`
	Workspace            workspaces.QueriableField `cli:"workspace" table:"user_workspace" column:"workspace" qs:"workspace"`
	UserPermissions      workspaces.QueriableField `cli:"user-permissions" table:"user_workspace" column:"user_permissions" qs:"userPermissions"`
	RolePermission       workspaces.QueriableField `cli:"role-permission" table:"user_workspace" column:"role_permission" qs:"rolePermission"`
	WorkspacePermissions workspaces.QueriableField `cli:"workspace-permissions" table:"user_workspace" column:"workspace_permissions" qs:"workspacePermissions"`
}
...
type UserWorkspaceEntity struct {
	...
	WorkspaceId workspaces.String `json:"workspaceId,omitempty" yaml:"workspaceId,omitempty" gorm:"index:userworkspace_idx,unique" `
	...
	UserId workspaces.String `json:"userId,omitempty" yaml:"userId,omitempty" gorm:"index:userworkspace_idx,unique" `
...
func UserWorkspaceEntityStream(q workspaces.QueryDSL) (chan []*UserWorkspaceEntity, *workspaces.QueryResultMeta, error) {
...
func (x *UserWorkspaceEntityList) ToTree() *workspaces.TreeOperation[UserWorkspaceEntity] {
...
type userWorkspaceActionsSig struct {
	Update         func(query workspaces.QueryDSL, dto *UserWorkspaceEntity) (*UserWorkspaceEntity, *workspaces.IError)
	Create         func(dto *UserWorkspaceEntity, query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError)
	Upsert         func(dto *UserWorkspaceEntity, query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError)
	SeederInit     func() *UserWorkspaceEntity
	Remove         func(query workspaces.QueryDSL) (int64, *workspaces.IError)
	MultiInsert    func(dtos []*UserWorkspaceEntity, query workspaces.QueryDSL) ([]*UserWorkspaceEntity, *workspaces.IError)
	GetOne         func(query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError)
	GetByWorkspace func(query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError)
	Query          func(query workspaces.QueryDSL) ([]*UserWorkspaceEntity, *workspaces.QueryResultMeta, error)
}
...
func UserWorkspaceActionUpsertFn(dto *UserWorkspaceEntity, query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError) {
	return nil, nil
}
...
type UserWorkspaceFieldMap struct {
	...
	UserPermissions      workspaces.TranslatedString `yaml:"userPermissions"`
	RolePermission       workspaces.TranslatedString `yaml:"rolePermission"`
	WorkspacePermissions workspaces.TranslatedString `yaml:"workspacePermissions"`
}

var UserWorkspaceEntityMetaConfig map[string]int64 = map[string]int64{}
var UserWorkspaceEntityJsonSchema = workspaces.ExtractEntityFields(reflect.ValueOf(&UserWorkspaceEntity{}))

func entityUserWorkspaceFormatter(dto *UserWorkspaceEntity, query workspaces.QueryDSL) {
	if dto == nil {
		return
	}
	if dto.Created > 0 {
...
func UserWorkspaceActionSeederMultiple(query workspaces.QueryDSL, count int) {
	successInsert := 0
	failureInsert := 0
	batchSize := 100
...
func UserWorkspaceActionSeeder(query workspaces.QueryDSL, count int) {
	successInsert := 0
	failureInsert := 0
	bar := progressbar.Default(int64(count))
	for i := 1; i <= count; i++ {
...
func UserWorkspaceAssociationCreate(dto *UserWorkspaceEntity, query workspaces.QueryDSL) error {
	return nil
}
...
**/
func UserWorkspaceRelationContentCreate(dto *UserWorkspaceEntity, query workspaces.QueryDSL) error {
	return nil
}
func UserWorkspaceRelationContentUpdate(dto *UserWorkspaceEntity, query workspaces.QueryDSL) error {
	return nil
}
func UserWorkspacePolyglotUpdateHandler(dto *UserWorkspaceEntity, query workspaces.QueryDSL) {
	if dto == nil {
		return
	}
}
 ...
 */
func UserWorkspaceValidator(dto *UserWorkspaceEntity, isPatch bool) *workspaces.IError {
...
func UserWorkspaceEntityPreSanitize(dto *UserWorkspaceEntity, query workspaces.QueryDSL) {
}
func UserWorkspaceEntityBeforeCreateAppend(dto *UserWorkspaceEntity, query workspaces.QueryDSL) {
	if dto.UniqueId == "" {
...
func UserWorkspaceRecursiveAddUniqueId(dto *UserWorkspaceEntity, query workspaces.QueryDSL) {
}
...
*
*/
func UserWorkspaceMultiInsertFn(dtos []*UserWorkspaceEntity, query workspaces.QueryDSL) ([]*UserWorkspaceEntity, *workspaces.IError) {
	if len(dtos) > 0 {
...
func UserWorkspaceActionBatchCreateFn(dtos []*UserWorkspaceEntity, query workspaces.QueryDSL) ([]*UserWorkspaceEntity, *workspaces.IError) {
...
func UserWorkspaceDeleteEntireChildren(query workspaces.QueryDSL, dto *UserWorkspaceEntity) *workspaces.IError {
	// intentionally removed this. It's hard to implement it, and probably wrong without
	// proper on delete cascade
	return nil
}
func UserWorkspaceActionCreateFn(dto *UserWorkspaceEntity, query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError) {
	// 1. Validate always
...
func UserWorkspaceActionGetOneFn(query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError) {
	...
	item, err := workspaces.GetOneEntity[UserWorkspaceEntity](query, refl)
	entityUserWorkspaceFormatter(item, query)
	return item, err
}
func UserWorkspaceActionGetByWorkspaceFn(query workspaces.QueryDSL) (*UserWorkspaceEntity, *workspaces.IError) {
	refl := reflect.ValueOf(&UserWorkspaceEntity{})
	item, err := workspaces.GetOneByWorkspaceEntity[UserWorkspaceEntity](query, refl)
	entityUserWorkspaceFormatter(item, query)
	return item, err
}
func UserWorkspaceActionQueryFn(query workspaces.QueryDSL) ([]*UserWorkspaceEntity, *workspaces.QueryResultMeta, error) {
	refl := reflect.ValueOf(&UserWorkspaceEntity{})
	items, meta, err := workspaces.QueryEntitiesPointer[UserWorkspaceEntity](query, refl)
...
func UserWorkspaceUpdateExec(dbref *gorm.DB, query workspaces.QueryDSL, fields *UserWorkspaceEntity) (*UserWorkspaceEntity, *workspaces.IError) {
...
var UserWorkspaceWipeCmd cli.Command = cli.Command{
	...
	Action: func(c *cli.Context) error {
		query := workspaces.CommonCliQueryDSLBuilderAuthorize(c, &workspaces.SecurityModel{
			ActionRequires:  []workspaces.PermissionInfo{PERM_ROOT_USER_WORKSPACE_DELETE},
...
func UserWorkspaceActionRemoveFn(query workspaces.QueryDSL) (int64, *workspaces.IError) {
	refl := reflect.ValueOf(&UserWorkspaceEntity{})
	query.ActionRequires = []workspaces.PermissionInfo{PERM_ROOT_USER_WORKSPACE_DELETE}
	return workspaces.RemoveEntity[UserWorkspaceEntity](query, refl)
}
func UserWorkspaceActionWipeClean(query workspaces.QueryDSL) (int64, error) {
	var err error
	var count int64 = 0
	{
		subCount, subErr := workspaces.WipeCleanEntity[UserWorkspaceEntity]()
		if subErr != nil {
...
func UserWorkspaceActionBulkUpdate(
	query workspaces.QueryDSL, dto *workspaces.BulkRecordRequest[UserWorkspaceEntity]) (
	*workspaces.BulkRecordRequest[UserWorkspaceEntity], *workspaces.IError,
) {
...
var UserWorkspaceEntityMeta = workspaces.TableMetaData{
...
func UserWorkspaceActionExport(
	...
	return workspaces.YamlExporterChannel[UserWorkspaceEntity](query, UserWorkspaceActions.Query, UserWorkspacePreloadRelations)
}
func UserWorkspaceActionExportT(
	query workspaces.QueryDSL,
) (chan []interface{}, *workspaces.IError) {
	return workspaces.YamlExporterChannelT[UserWorkspaceEntity](query, UserWorkspaceActions.Query, UserWorkspacePreloadRelations)
}
...
var UserWorkspaceCommonInteractiveCliFlags = []workspaces.CliInteractiveFlag{}
...
var UserWorkspaceCreateInteractiveCmd cli.Command = cli.Command{
	...
	Action: func(c *cli.Context) {
		query := workspaces.CommonCliQueryDSLBuilderAuthorize(c, &workspaces.SecurityModel{
			ActionRequires:  []workspaces.PermissionInfo{PERM_ROOT_USER_WORKSPACE_CREATE},
			ResolveStrategy: "user",
		})
		entity := &UserWorkspaceEntity{}
		workspaces.PopulateInteractively(entity, c, UserWorkspaceCommonInteractiveCliFlags)
...
var UserWorkspaceUpdateCmd cli.Command = cli.Command{
	...
	Action: func(c *cli.Context) error {
		query := workspaces.CommonCliQueryDSLBuilderAuthorize(c, &workspaces.SecurityModel{
			ActionRequires:  []workspaces.PermissionInfo{PERM_ROOT_USER_WORKSPACE_UPDATE},
			ResolveStrategy: "user",
		})
...
func UserWorkspaceSyncSeederFromFs(fsRef *embed.FS, fileNames []string, q workspaces.QueryDSL) {
...
func UserWorkspaceWriteQueryMock(ctx workspaces.MockQueryContext) {
	for _, lang := range ctx.Languages {
		...
		workspaces.WriteMockDataToFile(lang, "", "UserWorkspace", result)
	}
}
func UserWorkspacesActionQueryString(keyword string, page int) ([]string, *workspaces.QueryResultMeta, error) {
	searchFields := []string{
		`unique_id %"{keyword}"%`,
		`name %"{keyword}"%`,
	}
...
var UserWorkspaceImportExportCommands = []cli.Command{
	...
	cli.Command{
		...
		Action: func(c *cli.Context) error {
			if entity, err := workspaces.GetSeederFilenames(userWorkspaceSeedersFs, ""); err != nil {
				fmt.Println(err.Error())
			} else {
				f, _ := json.MarshalIndent(entity, "", "  ")
				fmt.Println(string(f))
...
var USER_WORKSPACE_ACTION_TABLE = workspaces.Module3Action{
	Name:          "table",
...
var USER_WORKSPACE_ACTION_QUERY = workspaces.Module3Action{
	Method: "GET",
	Url:    "/user-workspaces",
	SecurityModel: &workspaces.SecurityModel{
		ActionRequires:  []workspaces.PermissionInfo{PERM_ROOT_USER_WORKSPACE_QUERY},
		ResolveStrategy: "user",
	},
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			qs := &UserWorkspaceEntityQs{}
			workspaces.HttpQueryEntity(c, UserWorkspaceActions.Query, qs)
		},
	},
	Format:         "QUERY",
	Action:         UserWorkspaceActions.Query,
	...
	Flags:         append(workspaces.CommonQueryFlags, UserWorkspaceQsFlags...),
	Description:   "Queries all of the entities in database based on the standard query format (s+)",
}
var USER_WORKSPACE_ACTION_EXPORT = workspaces.Module3Action{
	Method: "GET",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			workspaces.HttpStreamFileChannel(c, UserWorkspaceActionExport)
		},
	},
	Format:         "QUERY",
...
var USER_WORKSPACE_ACTION_GET_ONE = workspaces.Module3Action{
	Method: "GET",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			workspaces.HttpGetEntity(c, UserWorkspaceActions.GetOne)
		},
	},
	Format:         "GET_ONE",
...
var USER_WORKSPACE_ACTION_POST_ONE = workspaces.Module3Action{
	Name:          "create",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			workspaces.HttpPostEntity(c, UserWorkspaceActions.Create)
		},
	},
	CliAction: func(c *cli.Context, security *workspaces.SecurityModel) error {
		result, err := workspaces.CliPostEntity(c, UserWorkspaceActions.Create, security)
...
var USER_WORKSPACE_ACTION_PATCH = workspaces.Module3Action{
	Name:          "update",
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			workspaces.HttpUpdateEntity(c, UserWorkspaceActions.Update)
		},
	},
...
var USER_WORKSPACE_ACTION_PATCH_BULK = workspaces.Module3Action{
	Method: "PATCH",
	Url:    "/user-workspaces",
	SecurityModel: &workspaces.SecurityModel{
		ActionRequires:  []workspaces.PermissionInfo{PERM_ROOT_USER_WORKSPACE_UPDATE},
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			workspaces.HttpUpdateEntities(c, UserWorkspaceActionBulkUpdate)
		},
	},
	Action:         UserWorkspaceActionBulkUpdate,
	Format:         "PATCH_BULK",
	RequestEntity:  &workspaces.BulkRecordRequest[UserWorkspaceEntity]{},
	ResponseEntity: &workspaces.BulkRecordRequest[UserWorkspaceEntity]{},
	Out: &workspaces.Module3ActionBody{
		Entity: "UserWorkspaceEntity",
	},
	In: &workspaces.Module3ActionBody{
...
var USER_WORKSPACE_ACTION_DELETE = workspaces.Module3Action{
	Method: "DELETE",
	Url:    "/user-workspace",
	Format: "DELETE_DSL",
	SecurityModel: &workspaces.SecurityModel{
	...
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			workspaces.HttpRemoveEntity(c, UserWorkspaceActions.Remove)
		},
	},
 ...
 **/
var AppendUserWorkspaceRouter = func(r *[]workspaces.Module3Action) {}

func GetUserWorkspaceModule3Actions() []workspaces.Module3Action {
...
var PERM_ROOT_USER_WORKSPACE = workspaces.PermissionInfo{
	CompleteKey: "root.manage.abac.user-workspace.*",
	Name:        "Entire user workspace actions (*)",
	Description: "",
}
var PERM_ROOT_USER_WORKSPACE_DELETE = workspaces.PermissionInfo{
	CompleteKey: "root.manage.abac.user-workspace.delete",
	Name:        "Delete user workspace",
	Description: "",
}
var PERM_ROOT_USER_WORKSPACE_CREATE = workspaces.PermissionInfo{
	CompleteKey: "root.manage.abac.user-workspace.create",
	Name:        "Create user workspace",
	Description: "",
}
var PERM_ROOT_USER_WORKSPACE_UPDATE = workspaces.PermissionInfo{
	CompleteKey: "root.manage.abac.user-workspace.update",
	Name:        "Update user workspace",
	Description: "",
}
var PERM_ROOT_USER_WORKSPACE_QUERY = workspaces.PermissionInfo{
	CompleteKey: "root.manage.abac.user-workspace.query",
	Name:        "Query user workspace",
	Description: "",
}
var ALL_USER_WORKSPACE_PERMISSIONS = []workspaces.PermissionInfo{
