...
type UserWorkspaceEntity struct {
	...
	WorkspaceId workspaces.String `json:"workspaceId,omitempty" xml:"workspaceId,omitempty" yaml:"workspaceId,omitempty" gorm:"index:userworkspace_idx,unique" `
	...
	UserId workspaces.String `json:"userId,omitempty" xml:"userId,omitempty" yaml:"userId,omitempty" gorm:"index:userworkspace_idx,unique" `
