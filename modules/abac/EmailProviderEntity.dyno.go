...
type emailProviderActionsSig struct {
	...
	Query          func(query fireback.QueryDSL) ([]*EmailProviderEntity, *fireback.QueryResultMeta, *fireback.IError)
}
...
var EmailProviderActions emailProviderActionsSig = emailProviderActionsSig{
	...
	RemoveEnqueue:  EmailProviderActionRemoveEnqueueFn,
...
func EmailProviderActionQueryFn(query fireback.QueryDSL) ([]*EmailProviderEntity, *fireback.QueryResultMeta, *fireback.IError) {
	refl := reflect.ValueOf(&EmailProviderEntity{})
...
func EmailProviderActionRemoveEnqueueFn(req fireback.DeleteRequest, query fireback.QueryDSL) (*fireback.DeleteResponse, *fireback.IError) {
	refl := reflect.ValueOf(&EmailProviderEntity{})
...
func EmailProvidersActionQueryString(keyword string, page int) ([]string, *fireback.QueryResultMeta, *fireback.IError) {
	searchFields := []string{
		`unique_id %"{keyword}"%`,
		`name %"{keyword}"%`,
	}
...
var EMAIL_PROVIDER_ACTION_DELETE_ENQUEUE = fireback.Module3Action{
	Method: "POST",
	Url:    "/email-provider-remove",
	SecurityModel: &fireback.SecurityModel{
		ActionRequires: []fireback.PermissionInfo{PERM_ROOT_EMAIL_PROVIDER_DELETE},
		AllowOnRoot:    true,
	},
	Handlers: []gin.HandlerFunc{
		func(c *gin.Context) {
			fireback.HttpRemoveEnqueueEntity(c, EmailProviderActions.RemoveEnqueue)
		},
	},
	Action:         EmailProviderActions.RemoveEnqueue,
...
func GetEmailProviderModule3Actions() []fireback.Module3Action {
	routes := []fireback.Module3Action{
		...
		EMAIL_PROVIDER_ACTION_DELETE_ENQUEUE,
	}
