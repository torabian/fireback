...
func init() {
	...
	/*
		EmailConfirmationActions.Create = func(dto *EmailConfirmationEntity, query QueryDSL) (*EmailConfirmationEntity, *IError) {
			// Do something before hand
			result, err := EmailConfirmationActionCreateFn(dto, query)
