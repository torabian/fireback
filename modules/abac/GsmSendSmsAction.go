...
func (x GsmSendSmsActionRequest) GetGinCtx() interface{} {
	return x.GinCtx
}

// Returns the urfave 3 cli context. You need to manullay cast to .(*cli.Command)
func (x GsmSendSmsActionRequest) GetCliCtx() interface{} {
	return x.CliCtx
}
...
// GsmSendSmsActionGin is a high-level convenience wrapper around GsmSendSmsActionHandler.
// It automatically constructs and registers the typed route on the Gin engine.
// Use this when you don't need custom middleware or route grouping.
func GsmSendSmsActionGin(r gin.IRoutes, handler func(c GsmSendSmsActionRequest) (*GsmSendSmsActionResponse, error)) {
...
// GsmSendSmsActionHttpHandler returns the HTTP method, the ServeMux pattern, and a
// typed net/http handler for the GsmSendSmsAction action. Developers implement
// their business logic as a function that receives a typed request object and
// returns either an *GsmSendSmsActionResponse or nil. JSON marshalling, headers,
// status codes, and errors are handled automatically.
func GsmSendSmsActionHttpHandler(
	handler func(c GsmSendSmsActionRequest) (*GsmSendSmsActionResponse, error),
...
// GsmSendSmsActionHttp is a high-level convenience wrapper around
// GsmSendSmsActionHttpHandler. It registers the typed route on a standard
// *http.ServeMux using Go 1.22+ method-aware pattern syntax (e.g. "POST /").
// Use this when you don't need custom middleware.
func GsmSendSmsActionHttp(
	mux *http.ServeMux,
	handler func(c GsmSendSmsActionRequest) (*GsmSendSmsActionResponse, error),
) {
	method, pattern, h := GsmSendSmsActionHttpHandler(handler)
