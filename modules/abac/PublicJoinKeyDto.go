...
func (x *PublicJoinKeyDto) Json() string {
	if x != nil {
...
func GetPublicJoinKeyDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastPublicJoinKeyDtoFromCli(c emigo.CliCastable) PublicJoinKeyDto {
	data := PublicJoinKeyDto{}
