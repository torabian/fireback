...
func (x *PassportEntity) FromCli(c *cli.Command) *PassportEntity {
	return CastPassportFromCli(c)
}
func CastPassportFromCli(c *cli.Command) *PassportEntity {
...
var PassportImportExportCommands = []cli.Command{
	{
		...
		Action: func(ctx context.Context, c *cli.Command) error {
			data := fireback.ContentImport[PassportEntity]{}
	...
	cli.Command{
		...
		Action: func(ctx context.Context, c *cli.Command) error {
			if seeders, err := fireback.GetSeederFilenames(passportSeedersFs, ""); err != nil {
				return err
			} else {
				if len(seeders) == 0 {
