WITH RECURSIVE
    fb_geo_location_entities_cte(level, unique_id, parent_id,visibility,updated,created,name,code,status,flag,official_name) AS (
    select * from (
        SELECT 0, fb_geo_location_entities.unique_id, fb_geo_location_entities.parent_id,fb_geo_location_entities.visibility,fb_geo_location_entities.updated,fb_geo_location_entities.created,fb_geo_location_entities.name,fb_geo_location_entities.code,fb_geo_location_entities.status,fb_geo_location_entities.flag,fb_geo_location_entities.official_name from fb_geo_location_entities
        where parent_id is null
        (internalCondition)
        limit @limit offset @offset
    )
    UNION ALL
    SELECT fb_geo_location_entities_cte.level+1,fb_geo_location_entities.unique_id, fb_geo_location_entities.parent_id,fb_geo_location_entities.visibility,fb_geo_location_entities.updated,fb_geo_location_entities.created,fb_geo_location_entities.name,fb_geo_location_entities.code,fb_geo_location_entities.status,fb_geo_location_entities.flag,fb_geo_location_entities.official_name
