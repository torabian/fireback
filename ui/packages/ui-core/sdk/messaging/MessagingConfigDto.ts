...
export class MessagingConfigDto {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<MessagingConfigDto>;
  ...
  /**
   * Creates an instance of MessagingConfigDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: MessagingConfigDtoType) {
    return new MessagingConfigDto(possibleDtoObject);
  }
  /**
   * Creates an instance of MessagingConfigDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<MessagingConfigDtoType>) {
    return new MessagingConfigDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<MessagingConfigDtoType>,
  ): InstanceType<typeof MessagingConfigDto> {
    return new MessagingConfigDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof MessagingConfigDto> {
    return new MessagingConfigDto(this.toJSON());
  }
}
export abstract class MessagingConfigDtoFactory {
  abstract create(data: unknown): MessagingConfigDto;
}
/**
 * The base type definition for messagingConfigDto
 **/
export type MessagingConfigDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace MessagingConfigDtoType {}
