 ...
 **/
export class WalletTransactionOptionalDto {
  /**
   *
   * @type {string}
   **/
  ...
  set direction(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#direction = correctType ? value : String(value);
  }
  setDirection(value: string | null | undefined) {
   ...
   * @type {string}
   **/
  set balanceAfter(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#balanceAfter = correctType ? value : String(value);
  }
  setBalanceAfter(value: string | null | undefined) {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<WalletTransactionOptionalDto>;
  ...
  /**
   * Creates an instance of WalletTransactionOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: WalletTransactionOptionalDtoType) {
    return new WalletTransactionOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of WalletTransactionOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<WalletTransactionOptionalDtoType>) {
    return new WalletTransactionOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<WalletTransactionOptionalDtoType>,
  ): InstanceType<typeof WalletTransactionOptionalDto> {
    return new WalletTransactionOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof WalletTransactionOptionalDto> {
    return new WalletTransactionOptionalDto(this.toJSON());
  }
}
export abstract class WalletTransactionOptionalDtoFactory {
  abstract create(data: unknown): WalletTransactionOptionalDto;
}
/**
 * The base type definition for walletTransactionOptionalDto
 **/
export type WalletTransactionOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace WalletTransactionOptionalDtoType {}
