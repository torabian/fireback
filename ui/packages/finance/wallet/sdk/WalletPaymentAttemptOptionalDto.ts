...
/**
 * The base class definition for walletPaymentAttemptOptionalDto
 **/
export class WalletPaymentAttemptOptionalDto {
  /**
   *
   * @type {string}
   **/
   ...
   * @type {string}
   **/
  set purpose(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#purpose = correctType ? value : String(value);
  }
  setPurpose(value: string | null | undefined) {
    this.purpose = value;
    return this;
  }
  /**
  ...
  set idempotencyKey(value: string | null | undefined) {
    const correctType =
      typeof value === "string" || value === undefined || value === null;
    this.#idempotencyKey = correctType ? value : String(value);
  }
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<WalletPaymentAttemptOptionalDto>;
  ...
  /**
   * Creates an instance of WalletPaymentAttemptOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: WalletPaymentAttemptOptionalDtoType) {
    return new WalletPaymentAttemptOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of WalletPaymentAttemptOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(
    partialDtoObject: PartialDeep<WalletPaymentAttemptOptionalDtoType>,
  ) {
    return new WalletPaymentAttemptOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<WalletPaymentAttemptOptionalDtoType>,
  ): InstanceType<typeof WalletPaymentAttemptOptionalDto> {
    return new WalletPaymentAttemptOptionalDto({
      ...this.toJSON(),
      ...partial,
    });
  }
  clone(): InstanceType<typeof WalletPaymentAttemptOptionalDto> {
    return new WalletPaymentAttemptOptionalDto(this.toJSON());
  }
}
export abstract class WalletPaymentAttemptOptionalDtoFactory {
  abstract create(data: unknown): WalletPaymentAttemptOptionalDto;
}
/**
 * The base type definition for walletPaymentAttemptOptionalDto
 **/
export type WalletPaymentAttemptOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace WalletPaymentAttemptOptionalDtoType {}
