 ...
 **/
export class WalletGatewayOptionalDto {
  /**
   *
   * @type {string}
   **/
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<WalletGatewayOptionalDto>;
  ...
  /**
   * Creates an instance of WalletGatewayOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: WalletGatewayOptionalDtoType) {
    return new WalletGatewayOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of WalletGatewayOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<WalletGatewayOptionalDtoType>) {
    return new WalletGatewayOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<WalletGatewayOptionalDtoType>,
  ): InstanceType<typeof WalletGatewayOptionalDto> {
    return new WalletGatewayOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof WalletGatewayOptionalDto> {
    return new WalletGatewayOptionalDto(this.toJSON());
  }
}
export abstract class WalletGatewayOptionalDtoFactory {
  abstract create(data: unknown): WalletGatewayOptionalDto;
}
/**
 * The base type definition for walletGatewayOptionalDto
 **/
export type WalletGatewayOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace WalletGatewayOptionalDtoType {}
