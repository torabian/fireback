 ...
 **/
export class EmailProviderOptionalDto {
  /**
   *
   * @type {string}
   **/
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<EmailProviderOptionalDto>;
  ...
  /**
   * Creates an instance of EmailProviderOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: EmailProviderOptionalDtoType) {
    return new EmailProviderOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of EmailProviderOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<EmailProviderOptionalDtoType>) {
    return new EmailProviderOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<EmailProviderOptionalDtoType>,
  ): InstanceType<typeof EmailProviderOptionalDto> {
    return new EmailProviderOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof EmailProviderOptionalDto> {
    return new EmailProviderOptionalDto(this.toJSON());
  }
}
export abstract class EmailProviderOptionalDtoFactory {
  abstract create(data: unknown): EmailProviderOptionalDto;
}
/**
 * The base type definition for emailProviderOptionalDto
 **/
export type EmailProviderOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace EmailProviderOptionalDtoType {}
