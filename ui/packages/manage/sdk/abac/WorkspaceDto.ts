...
export class WorkspaceDto {
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<WorkspaceDto>;
  ...
  /**
   * Creates an instance of WorkspaceDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: WorkspaceDtoType) {
    return new WorkspaceDto(possibleDtoObject);
  }
  /**
   * Creates an instance of WorkspaceDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<WorkspaceDtoType>) {
    return new WorkspaceDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<WorkspaceDtoType>,
  ): InstanceType<typeof WorkspaceDto> {
    return new WorkspaceDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof WorkspaceDto> {
    return new WorkspaceDto(this.toJSON());
  }
}
export abstract class WorkspaceDtoFactory {
  abstract create(data: unknown): WorkspaceDto;
}
/**
 * The base type definition for workspaceDto
 **/
...
export namespace WorkspaceDtoType {}
