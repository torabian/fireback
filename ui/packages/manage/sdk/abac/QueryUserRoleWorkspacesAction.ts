...
export class QueryUserRoleWorkspacesActionRes {
   ...
   **/
  #roles: MArray<InstanceType<typeof QueryUserRoleWorkspacesActionRes.Roles>> =
    MArray.of([]);
  /**
   *
  ...
  set roles(
    value:
      | MArray<InstanceType<typeof QueryUserRoleWorkspacesActionRes.Roles>>
    ...
    if (Array.isArray(value)) {
      if (
        ...
        this.#roles = MArray.of(
          value.map((item) => new QueryUserRoleWorkspacesActionRes.Roles(item)),
        );
      }
      return;
    }
