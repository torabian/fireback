...
} from "@fireback/selfservice/sdk/abac/ConfirmClassicPassportTotpAction";
...
export const usePresenter = () => {
  ...
  const submit = (values: Partial<ConfirmClassicPassportTotpActionReq>) => {
    mutation
      .mutateAsync(
        new ConfirmClassicPassportTotpActionReq({ ...values, password, value }),
      )
      .then(successful)
      .catch((error) => {
  ...
  const successful = (res: GResponse<ConfirmClassicPassportTotpActionRes>) => {
