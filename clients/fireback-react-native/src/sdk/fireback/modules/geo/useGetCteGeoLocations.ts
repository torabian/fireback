...
export function useGetCteGeoLocations({
  ...
  const url = "/cte-geo-locations".substr(1);
  ...
  const query$ = useQuery<any, any, IResponseList<GeoLocationEntity>, any>(["*geo.GeoLocationEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetCteGeoLocations.UKEY = "*geo.GeoLocationEntity"