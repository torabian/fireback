...
export function useGetCustomersExport({
  queryOptions,
  query,
  queryClient,
  execFnOverride,
  ...
  const url = "/customers/export".substr(1);
  ...
  const query$ = useQuery<any, any, IResponseList<CustomerEntity>, any>(["*demo.CustomerEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetCustomersExport.UKEY = "*demo.CustomerEntity"