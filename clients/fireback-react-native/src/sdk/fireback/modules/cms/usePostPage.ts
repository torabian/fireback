...
export function usePostPage(props?: UseRemoteQuery) {
  ...
  const submit = (
    ...
    formikProps?: FormikHelpers<Partial<PageEntity>>
  ): Promise<IResponse<PageEntity>> => {
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<PageEntity>) {
          queryClient?.setQueryData<IResponseList<PageEntity>>(
            "*cms.PageEntity",
