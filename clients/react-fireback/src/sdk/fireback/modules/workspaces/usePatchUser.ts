...
export function usePatchUser({
  ...
  const fn = (entity: any) => Q().patchUser(entity);

  const mutation = useMutation<
    IResponse<workspaces.UserEntity>,
    IResponse<workspaces.UserEntity>,
    Partial<workspaces.UserEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<workspaces.UserEntity>,
    formikProps?: FormikHelpers<Partial<workspaces.UserEntity>>
