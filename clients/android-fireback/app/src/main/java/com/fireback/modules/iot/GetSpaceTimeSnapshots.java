...
/*
*/
public class GetSpaceTimeSnapshots {
    private Context context;
    public GetSpaceTimeSnapshots(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/space-time-snapshots");
