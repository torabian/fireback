...
public class PostNodeDatum {
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/node-datum");
    public Single<SingleResponse<NodeDatumEntity>> post(NodeDatumEntity dto) {
        return Single.fromCallable(() -> makeHttpPostRequest(dto))
                .subscribeOn(Schedulers.io());
    }
    private SingleResponse<NodeDatumEntity> makeHttpPostRequest(NodeDatumEntity dto) throws IOException {
