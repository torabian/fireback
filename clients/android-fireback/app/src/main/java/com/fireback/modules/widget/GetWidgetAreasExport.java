...
/*
*/
public class GetWidgetAreasExport {
    private Context context;
    public GetWidgetAreasExport(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/widget-areas/export");
