...
import Combine
import SwiftUI
func GetActivationKeysFetcher() -> AnyPublisher<ArrayResponse<ActivationKeyEntity>, Error> {
    var computedUrl = "http://localhost:61901/activation-keys"
...
func GetActivationKeys() -> Promise<[ActivationKeyEntity]?> {
