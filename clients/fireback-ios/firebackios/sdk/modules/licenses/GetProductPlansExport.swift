...
import Combine
import SwiftUI
func GetProductPlansExportFetcher() -> AnyPublisher<ArrayResponse<ProductPlanEntity>, Error> {
    var computedUrl = "http://localhost:61901/product-plans/export"
...
func GetProductPlansExport() -> Promise<[ProductPlanEntity]?> {
