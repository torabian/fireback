import Promises
func PostLicensableProductsGenerate(dto: LicensableProductEntity) -> Promise<LicensableProductEntity?> {
    return Promise<LicensableProductEntity?>(on: .main) { fulfill, reject in
        ...
        let url = URL(string: "http://localhost:61901/licensableProducts/generate")!
