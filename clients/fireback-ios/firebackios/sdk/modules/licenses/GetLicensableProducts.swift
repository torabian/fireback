...
import Combine
import SwiftUI
func GetLicensableProductsFetcher() -> AnyPublisher<ArrayResponse<LicensableProductEntity>, Error> {
    var computedUrl = "http://localhost:61901/licensable-products"
...
func GetLicensableProducts() -> Promise<[LicensableProductEntity]?> {
