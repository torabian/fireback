...
import Combine
import SwiftUI
func GetWidgetsExportFetcher() -> AnyPublisher<ArrayResponse<WidgetEntity>, Error> {
    var computedUrl = "http://localhost:61901/widgets/export"
