...
import Combine
import SwiftUI
func GetPublicWorkspaceTypesFetcher() -> AnyPublisher<ArrayResponse<WorkspaceTypeEntity>, Error> {
    var computedUrl = "http://localhost:61901/publicWorkspaceTypes"
...
func GetPublicWorkspaceTypes() -> Promise<[WorkspaceTypeEntity]?> {
