...
import Combine
import SwiftUI
func GetRegionalContentsExportFetcher() -> AnyPublisher<ArrayResponse<RegionalContentEntity>, Error> {
    var computedUrl = "http://localhost:61901/regional-contents/export"
...
func GetRegionalContentsExport() -> Promise<[RegionalContentEntity]?> {
