...
import Combine
import SwiftUI
func GetGsmProvidersFetcher() -> AnyPublisher<ArrayResponse<GsmProviderEntity>, Error> {
    var computedUrl = "http://localhost:61901/gsm-providers"
