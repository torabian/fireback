...
import Combine
import SwiftUI
func GetBackupTableMetasFetcher() -> AnyPublisher<ArrayResponse<BackupTableMetaEntity>, Error> {
    var computedUrl = "http://localhost:61901/backup-table-metas"
...
func GetBackupTableMetas() -> Promise<[BackupTableMetaEntity]?> {
