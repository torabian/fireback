...
import Combine
import SwiftUI
func GetCapabilitiesFetcher() -> AnyPublisher<ArrayResponse<CapabilityEntity>, Error> {
    var computedUrl = "http://localhost:61901/capabilities"
...
func GetCapabilities() -> Promise<[CapabilityEntity]?> {
