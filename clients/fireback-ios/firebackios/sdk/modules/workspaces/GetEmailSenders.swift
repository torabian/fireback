...
import Combine
import SwiftUI
func GetEmailSendersFetcher() -> AnyPublisher<ArrayResponse<EmailSenderEntity>, Error> {
    var computedUrl = "http://localhost:61901/email-senders"
...
func GetEmailSenders() -> Promise<[EmailSenderEntity]?> {
