...
import Combine
import SwiftUI
func GetPublicJoinKeysFetcher() -> AnyPublisher<ArrayResponse<PublicJoinKeyEntity>, Error> {
    var computedUrl = "http://localhost:61901/public-join-keys"
...
func GetPublicJoinKeys() -> Promise<[PublicJoinKeyEntity]?> {
