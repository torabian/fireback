...
import Combine
import SwiftUI
func GetEmailConfirmationsFetcher() -> AnyPublisher<ArrayResponse<EmailConfirmationEntity>, Error> {
    var computedUrl = "http://localhost:61901/email-confirmations"
...
func GetEmailConfirmations() -> Promise<[EmailConfirmationEntity]?> {
