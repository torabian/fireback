...
import Combine
import SwiftUI
func GetCteUserRoleWorkspacesFetcher() -> AnyPublisher<ArrayResponse<UserRoleWorkspaceEntity>, Error> {
    var computedUrl = "http://localhost:61901/cte-user-role-workspaces"
...
func GetCteUserRoleWorkspaces() -> Promise<[UserRoleWorkspaceEntity]?> {
