...
import Combine
import SwiftUI
func GetAppMenusExportFetcher() -> AnyPublisher<ArrayResponse<AppMenuEntity>, Error> {
    var computedUrl = "http://localhost:61901/app-menus/export"
...
func GetAppMenusExport() -> Promise<[AppMenuEntity]?> {
