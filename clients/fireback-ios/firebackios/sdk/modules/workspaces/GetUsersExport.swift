...
import Combine
import SwiftUI
func GetUsersExportFetcher() -> AnyPublisher<ArrayResponse<UserEntity>, Error> {
    var computedUrl = "http://localhost:61901/users/export"
...
func GetUsersExport() -> Promise<[UserEntity]?> {
