...
import Combine
import SwiftUI
func GetWorkspaceInvitesExportFetcher() -> AnyPublisher<ArrayResponse<WorkspaceInviteEntity>, Error> {
    var computedUrl = "http://localhost:61901/workspace-invites/export"
...
func GetWorkspaceInvitesExport() -> Promise<[WorkspaceInviteEntity]?> {
