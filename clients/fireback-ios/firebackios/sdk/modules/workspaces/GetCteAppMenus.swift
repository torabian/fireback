...
import Combine
import SwiftUI
func GetCteAppMenusFetcher() -> AnyPublisher<ArrayResponse<AppMenuEntity>, Error> {
    var computedUrl = "http://localhost:61901/cte-app-menus"
...
func GetCteAppMenus() -> Promise<[AppMenuEntity]?> {
