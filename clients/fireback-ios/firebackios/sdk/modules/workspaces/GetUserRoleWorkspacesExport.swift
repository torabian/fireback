...
import Combine
import SwiftUI
func GetUserRoleWorkspacesExportFetcher() -> AnyPublisher<ArrayResponse<UserRoleWorkspaceEntity>, Error> {
    var computedUrl = "http://localhost:61901/user-role-workspaces/export"
...
func GetUserRoleWorkspacesExport() -> Promise<[UserRoleWorkspaceEntity]?> {
