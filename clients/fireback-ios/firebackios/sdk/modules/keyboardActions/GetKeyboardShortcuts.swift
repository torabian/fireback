...
import Combine
import SwiftUI
func GetKeyboardShortcutsFetcher() -> AnyPublisher<ArrayResponse<KeyboardShortcutEntity>, Error> {
    var computedUrl = "http://localhost:61901/keyboard-shortcuts"
...
func GetKeyboardShortcuts() -> Promise<[KeyboardShortcutEntity]?> {
