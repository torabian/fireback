...
import Combine
import SwiftUI
func GetExpanderFunctionsFetcher() -> AnyPublisher<ArrayResponse<ExpanderFunctionEntity>, Error> {
    var computedUrl = "http://localhost:61901/expander-functions"
...
func GetExpanderFunctions() -> Promise<[ExpanderFunctionEntity]?> {
