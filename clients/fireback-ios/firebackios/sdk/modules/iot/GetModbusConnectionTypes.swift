...
import Combine
import SwiftUI
func GetModbusConnectionTypesFetcher() -> AnyPublisher<ArrayResponse<ModbusConnectionTypeEntity>, Error> {
    var computedUrl = "http://localhost:61901/modbus-connection-types"
...
func GetModbusConnectionTypes() -> Promise<[ModbusConnectionTypeEntity]?> {
