...
import Combine
import SwiftUI
func GetDataNodeModesFetcher() -> AnyPublisher<ArrayResponse<DataNodeModeEntity>, Error> {
    var computedUrl = "http://localhost:61901/data-node-modes"
...
func GetDataNodeModes() -> Promise<[DataNodeModeEntity]?> {
