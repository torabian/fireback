...
import Combine
import SwiftUI
func GetNodeWritersExportFetcher() -> AnyPublisher<ArrayResponse<NodeWriterEntity>, Error> {
    var computedUrl = "http://localhost:61901/node-writers/export"
