...
import Combine
import SwiftUI
func GetModbusFunctionCodesExportFetcher() -> AnyPublisher<ArrayResponse<ModbusFunctionCodeEntity>, Error> {
    var computedUrl = "http://localhost:61901/modbus-function-codes/export"
...
func GetModbusFunctionCodesExport() -> Promise<[ModbusFunctionCodeEntity]?> {
