import Promises
func PostModbusConnectionType(dto: ModbusConnectionTypeEntity) -> Promise<ModbusConnectionTypeEntity?> {
    return Promise<ModbusConnectionTypeEntity?>(on: .main) { fulfill, reject in
        ...
        let url = URL(string: "http://localhost:61901/modbus-connection-type")!
