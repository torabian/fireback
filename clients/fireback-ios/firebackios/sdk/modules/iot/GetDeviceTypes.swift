...
import Combine
import SwiftUI
func GetDeviceTypesFetcher() -> AnyPublisher<ArrayResponse<DeviceTypeEntity>, Error> {
    var computedUrl = "http://localhost:61901/device-types"
...
func GetDeviceTypes() -> Promise<[DeviceTypeEntity]?> {
