import Foundation
struct DnReadMQTTTopicConfigDto : Codable {
...
class DnReadMQTTTopicConfigDtoViewModel: ObservableObject {
  ...
  func getDto() -> DnReadMQTTTopicConfigDto {
      var dto = DnReadMQTTTopicConfigDto()
