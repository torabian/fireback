...
import Combine
import SwiftUI
func GetGpiosExportFetcher() -> AnyPublisher<ArrayResponse<GpioEntity>, Error> {
    var computedUrl = "http://localhost:61901/gpios/export"
