...
import Combine
import SwiftUI
func GetNodeWritersFetcher() -> AnyPublisher<ArrayResponse<NodeWriterEntity>, Error> {
    var computedUrl = "http://localhost:61901/node-writers"
...
func GetNodeWriters() -> Promise<[NodeWriterEntity]?> {
