...
import Combine
import SwiftUI
func GetModbusVariableTypesExportFetcher() -> AnyPublisher<ArrayResponse<ModbusVariableTypeEntity>, Error> {
    var computedUrl = "http://localhost:61901/modbus-variable-types/export"
...
func GetModbusVariableTypesExport() -> Promise<[ModbusVariableTypeEntity]?> {
