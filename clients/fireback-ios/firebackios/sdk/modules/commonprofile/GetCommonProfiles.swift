...
import Combine
import SwiftUI
func GetCommonProfilesFetcher() -> AnyPublisher<ArrayResponse<CommonProfileEntity>, Error> {
    var computedUrl = "http://localhost:61901/common-profiles"
...
func GetCommonProfiles() -> Promise<[CommonProfileEntity]?> {
