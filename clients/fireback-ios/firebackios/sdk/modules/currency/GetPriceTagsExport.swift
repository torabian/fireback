...
import Combine
import SwiftUI
func GetPriceTagsExportFetcher() -> AnyPublisher<ArrayResponse<PriceTagEntity>, Error> {
    var computedUrl = "http://localhost:61901/price-tags/export"
