...
import Combine
import SwiftUI
func GetCurrenciesFetcher() -> AnyPublisher<ArrayResponse<CurrencyEntity>, Error> {
    var computedUrl = "http://localhost:61901/currencies"
...
func GetCurrencies() -> Promise<[CurrencyEntity]?> {
