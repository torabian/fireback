...
import Combine
import SwiftUI
func GetPriceTagsFetcher() -> AnyPublisher<ArrayResponse<PriceTagEntity>, Error> {
    var computedUrl = "http://localhost:61901/price-tags"
...
func GetPriceTags() -> Promise<[PriceTagEntity]?> {
