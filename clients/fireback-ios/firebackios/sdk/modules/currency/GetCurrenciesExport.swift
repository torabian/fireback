...
import Combine
import SwiftUI
func GetCurrenciesExportFetcher() -> AnyPublisher<ArrayResponse<CurrencyEntity>, Error> {
    var computedUrl = "http://localhost:61901/currencies/export"
