...
/*
*/
public class GetCapabilitiesExport {
    private Context context;
    public GetCapabilitiesExport(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/capabilities/export");
