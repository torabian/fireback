...
/*
import com.fireback.PublicJoinKeyEntity;
*/
...
public class PostPublicJoinKey {
    ...
    private SingleResponse<PublicJoinKeyEntity> makeHttpPostRequest(PublicJoinKeyEntity dto) throws ResponseErrorException {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.isSuccessful()) {
                SingleResponse<PublicJoinKeyEntity> res = SingleResponse.fromJson(response.body().string(), PublicJoinKeyEntity.class);
                response.close();
                return res;
            } else {
