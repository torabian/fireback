...
public class KeyboardShortcutEntity extends JsonSerializable {
  ...
  public static class VM extends ViewModel {
    ...
    private MutableLiveData< KeyboardShortcutDefaultCombination > defaultCombination = new MutableLiveData<>();
    ...
    private MutableLiveData< KeyboardShortcutUserCombination > userCombination = new MutableLiveData<>();
