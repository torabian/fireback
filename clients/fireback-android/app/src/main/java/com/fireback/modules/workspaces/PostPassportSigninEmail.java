...
/*
import com.fireback.EmailAccountSigninDto;
...
public class PostPassportSigninEmail {
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/passport/signin/email");
    ...
    private SingleResponse<UserSessionDto> makeHttpPostRequest(EmailAccountSigninDto dto) throws ResponseErrorException {
