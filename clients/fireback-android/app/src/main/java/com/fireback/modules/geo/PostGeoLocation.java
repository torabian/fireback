...
/*
import com.fireback.GeoLocationEntity;
*/
...
public class PostGeoLocation {
    ...
    private SingleResponse<GeoLocationEntity> makeHttpPostRequest(GeoLocationEntity dto) throws ResponseErrorException {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.isSuccessful()) {
                SingleResponse<GeoLocationEntity> res = SingleResponse.fromJson(response.body().string(), GeoLocationEntity.class);
                response.close();
                return res;
            } else {
