...
class ProductPlanPermissions extends JsonSerializable {
  ...
  public static class VM extends ViewModel {
    ...
    private MutableLiveData<com.fireback.modules.workspaces.CapabilityEntity> capability =
        new MutableLiveData<>();
...
public class ProductPlanEntity extends JsonSerializable {
  ...
  public static class VM extends ViewModel {
    ...
    private MutableLiveData<com.fireback.modules.currency.PriceTagEntity> priceTag =
        new MutableLiveData<>();
