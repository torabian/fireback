...
/*
*/
public class GetNotificationConfigs {
    private Context context;
    public GetNotificationConfigs(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/notification-configs");
