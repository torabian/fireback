...
import com.fireback.ImportUserActionReqDto;
*/
...
public class PostUserImport {
    private String getUrl() {
        return FirebackConfig.getInstance().BuildUrl("/user/import");
    }
    public Single<SingleResponse<OkayResponseDto>> post(ImportUserAction.Req dto) {
        return Single.fromCallable(() -> makeHttpPostRequest(dto))
                .subscribeOn(Schedulers.io());
    }
    private SingleResponse<OkayResponseDto> makeHttpPostRequest(ImportUserAction.Req dto) throws ResponseErrorException {
