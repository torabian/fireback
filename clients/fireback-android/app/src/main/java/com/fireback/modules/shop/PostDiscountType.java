...
/*
import com.fireback.DiscountTypeEntity;
*/
...
public class PostDiscountType {
    ...
    private SingleResponse<DiscountTypeEntity> makeHttpPostRequest(DiscountTypeEntity dto) throws ResponseErrorException {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.isSuccessful()) {
                SingleResponse<DiscountTypeEntity> res = SingleResponse.fromJson(response.body().string(), DiscountTypeEntity.class);
                response.close();
                return res;
            } else {
