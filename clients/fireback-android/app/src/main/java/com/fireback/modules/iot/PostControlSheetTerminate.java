...
public class PostControlSheetTerminate {
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/controlSheet/terminate");
    public Single<SingleResponse<OkayResponseDto>> post(ControlSheetEntity dto) {
        return Single.fromCallable(() -> makeHttpPostRequest(dto))
                .subscribeOn(Schedulers.io());
    }
    private SingleResponse<OkayResponseDto> makeHttpPostRequest(ControlSheetEntity dto) throws IOException {
