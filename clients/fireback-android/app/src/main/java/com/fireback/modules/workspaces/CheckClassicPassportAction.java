...
public class CheckClassicPassportAction {
    ...
    public static class ReqViewModel extends ViewModel {
        ...
        private MutableLiveData<String> valueMessage = new MutableLiveData<>();

        public MutableLiveData<String> getValueMessage() {
            return valueMessage;
        }

        public void setValueMessage(String v) {
            valueMessage.setValue(v);
        }
    }
