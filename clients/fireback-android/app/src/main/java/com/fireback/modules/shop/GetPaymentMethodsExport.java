...
/*
*/
public class GetPaymentMethodsExport {
    private Context context;
    public GetPaymentMethodsExport(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/payment-methods/export");
