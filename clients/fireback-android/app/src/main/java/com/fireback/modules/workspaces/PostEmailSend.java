...
public class PostEmailSend {
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/email/send");
    ...
    private SingleResponse<SendEmailAction.Res> makeHttpPostRequest(SendEmailAction.Req dto) throws IOException {
