...
/*
*/
public class GetTimezoneGroupsExport {
    private Context context;
    public GetTimezoneGroupsExport(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/timezone-groups/export");
