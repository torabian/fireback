...
/*
import com.fireback.ClassicAuthDto;
...
public class PostPassportSignupEmail {
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/passport/signup/email");
    public Single<SingleResponse<UserSessionDto>> post(ClassicAuthDto dto) {
        return Single.fromCallable(() -> makeHttpPostRequest(dto))
                .subscribeOn(Schedulers.io());
    }
    private SingleResponse<UserSessionDto> makeHttpPostRequest(ClassicAuthDto dto) throws ResponseErrorException {
