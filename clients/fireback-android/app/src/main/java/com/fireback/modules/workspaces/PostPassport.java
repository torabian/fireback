...
public class PostPassport {
    private String getUrl() {
        return FirebackConfig.getInstance().BuildUrl("/passport");
    }
    ...
    private SingleResponse<PassportEntity> makeHttpPostRequest(PassportEntity dto) throws ResponseErrorException {
