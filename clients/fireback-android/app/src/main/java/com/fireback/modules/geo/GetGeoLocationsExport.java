...
/*
*/
public class GetGeoLocationsExport {
    private Context context;
    public GetGeoLocationsExport(Context ctx ) {
        context = ctx;
    }
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/geo-locations/export");
