...
public class PostLicense {
    public static String Url  = FirebackConfig.getInstance().BuildUrl("/license");
    public Single<SingleResponse<LicenseEntity>> post(LicenseEntity dto) {
        return Single.fromCallable(() -> makeHttpPostRequest(dto))
                .subscribeOn(Schedulers.io());
    }
    private SingleResponse<LicenseEntity> makeHttpPostRequest(LicenseEntity dto) throws ResponseErrorException {
