...
public class PostPassportsSigninClassic {
    private String getUrl() {
        return FirebackConfig.getInstance().BuildUrl("/passports/signin/classic");
    }
    ...
    private SingleResponse<UserSessionDto> makeHttpPostRequest(ClassicSigninAction.Req dto) throws ResponseErrorException {
