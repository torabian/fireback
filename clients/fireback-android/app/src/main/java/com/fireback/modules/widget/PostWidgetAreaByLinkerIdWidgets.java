...
public class PostWidgetAreaByLinkerIdWidgets {
    private String getUrl() {
        return FirebackConfig.getInstance().BuildUrl("/widget-area/:linkerId/widgets");
    }
    ...
    private SingleResponse<WidgetAreaWidgets> makeHttpPostRequest(WidgetAreaWidgets dto) throws ResponseErrorException {
