...
export function usePatchProductPlanByLinkerIdPermissionsAndUniqueId(props?: PatchProps) {
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<ProductPlanPermissions>) {
          queryClient?.setQueriesData("*licenses.ProductPlanPermissions", (data: any) =>
