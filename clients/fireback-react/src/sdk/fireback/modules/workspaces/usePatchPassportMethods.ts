...
export function usePatchPassportMethods({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchPassportMethods(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<workspaces.PassportMethodEntity>>,
    IResponse<core.BulkRecordRequest<workspaces.PassportMethodEntity>>,
    Partial<core.BulkRecordRequest<workspaces.PassportMethodEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<workspaces.PassportMethodEntity>>,
