...
export function usePatchTableViewSizings({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchTableViewSizings(entity);

  const mutation = useMutation<
    IResponse<core.BulkRecordRequest<workspaces.TableViewSizingEntity>>,
    IResponse<core.BulkRecordRequest<workspaces.TableViewSizingEntity>>,
    Partial<core.BulkRecordRequest<workspaces.TableViewSizingEntity>>
  >(fn);
  ...
  const submit = (
    values: Partial<core.BulkRecordRequest<workspaces.TableViewSizingEntity>>,
