...
export function usePatchWorkspaceTypeDistinct({
  queryClient,
  query,
  execFnOverride,
}: {
  ...
  const fn = (entity: any) => Q().patchWorkspaceTypeDistinct(entity);

  const mutation = useMutation<
    IResponse<workspaces.WorkspaceTypeEntity>,
    IResponse<workspaces.WorkspaceTypeEntity>,
    Partial<workspaces.WorkspaceTypeEntity>
  >(fn);
  ...
  const submit = (
    values: Partial<workspaces.WorkspaceTypeEntity>,
    formikProps?: FormikHelpers<Partial<workspaces.WorkspaceTypeEntity>>
