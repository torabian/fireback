...
export function useDeleteTimezoneGroup(props?: DeleteProps) {
        ...
        onSuccess(response: IDeleteResponse) {
          ...
          */
          queryClient?.setQueryData<IDeleteResponse>(
            "*worldtimezone.TimezoneGroupEntity",
            (data) => fnUpdater(data, response) as any
          );
          queryClient?.invalidateQueries("*worldtimezone.TimezoneGroupEntity");
          resolve(response);
        },
        onError(error: any) {
