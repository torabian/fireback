...
export function usePostOrderByLinkerIdTotalPrice(props?: UseRemoteQuery) {
  ...
  const url = "/order/:linkerId/total_price".substr(1);
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<OrderTotalPrice>) {
          queryClient?.setQueryData<IResponseList<OrderTotalPrice>>(
            "*shop.OrderTotalPrice",
