...
export function usePatchProductSubmissionByLinkerIdPriceAndUniqueId(props?: PatchProps) {
  ...
  const url = "/product-submission/:linkerId/price/:uniqueId".substr(1);
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<ProductSubmissionPrice>) {
          queryClient?.setQueriesData("*shop.ProductSubmissionPrice", (data: any) =>
