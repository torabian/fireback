...
export function usePostProductByLinkerIdFields(props?: UseRemoteQuery) {
  ...
  const url = "/product/:linkerId/fields".substr(1);
    ...
    return new Promise((resolve, reject) => {
      mutation.mutate(values, {
        onSuccess(response: IResponse<ProductFields>) {
          queryClient?.setQueryData<IResponseList<ProductFields>>(
            "*shop.ProductFields",
