...
export function useGetGeoStatesExport({
  ...
  const url = "/geo-states/export".substr(1);
  ...
  const query$ = useQuery<any, any, IResponseList<GeoStateEntity>, any>(["*geo.GeoStateEntity", computedOptions, query], fn, {
    cacheTime: 1000,
    retry: false,
...
useGetGeoStatesExport.UKEY = "*geo.GeoStateEntity"