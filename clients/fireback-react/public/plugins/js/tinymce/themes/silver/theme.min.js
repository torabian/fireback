...
!(function () {
  ...
  const t_ = Ol({ fields: e_, name: "streaming", active: YO, state: QO }),
    ...
    AT = (e) => {
      ...
      return kT(
        "header",
        null !== (t = CT(e)) && void 0 !== t ? t : "",
        "#" + o,
        ((e) => (_T(e) ? parseInt(e.nodeName.substr(1), 10) : 0))(e),
        () => {
          e.id = o;
        }
      );
    ...
    BT = (e) => {
      ...
      return U(
        ((e) => H(U(e, ET), AT))(t).concat(((e) => H(U(e, OT), MT))(t)),
        DT
      );
    },
    ...
    WT = (e) => ({
      ...
      getLinkInformation: () =>
        ((e) =>
          Vf(e)
            ? A.some({
                targets: BT(e.getBody()),
                anchorTop: UT(zf(e)),
                anchorBottom: UT(Hf(e)),
              })
            : A.none())(e),
  ...
  const ME = Ol({
    ...
    VE = (e, t) => {
      t
        ? (Pa(e, BE.fadeOutClass), Wa(e, [BE.transitionClass, BE.fadeInClass]))
        : (Pa(e, BE.fadeInClass), Wa(e, [BE.fadeOutClass, BE.transitionClass]));
    },
    zE = (e, t) => {
    ...
    HE = (e, t) => {
      const o = Ql(),
        ...
        a = e.inline
          ? []
          : [Al.config({ channels: { [DE()]: { onReceive: NE } } })];
      return [
        oh.config({}),
        ME.config({
          contextual: {
  ...
  const qE = "container",
    ...
    ZE = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = [];
            return {
              slot: (t, o) => (e.push(t), Ju(qE, KE(t), o)),
              record: x(e),
            };
          })(),
          o = e(t),
    ...
    oA = (e) =>
      ZE.sketch((t) => ({
        ...
        components: tA(t, e),
        slotBehaviours: iy([Yr((e) => ZE.hideAllSlots(e))]),
      })),
    nA = (e, t) => {
      kt(e, "role", t);
    },
      ...
      wm
        ...
        .bind((e) =>
          VO.isGrowing(e) || VO.hasGrown(e)
            ? wm
                .getCurrent(e)
                .bind((e) => G(ZE.getSlotNames(e), (t) => ZE.isShowing(e, t)))
            : A.none()
        ),
    rA = la("FixSizeEvent"),
    aA = la("AutoSizeEvent");
  ...
  const cA = Ol({
        ...
        return {
          ...
          behaviours: bu(e.splitToolbarBehaviours, [
            dw.config({
              others: {
                overflowGroup: () =>
                  DA.sketch({ ...n["overflow-group"](), items: [s.asSpec()] }),
              },
            }),
          ]),
          apis: {
    ...
    GA = (e) => {
      ...
      return HA.sketch({
        ...
        onOpened: (t) => {
          t.getSystem().broadcastOn([DE()], { type: "opened" }),
            e.onToggled(t, !0);
        },
        onClosed: (t) => {
          t.getSystem().broadcastOn([DE()], { type: "closed" }),
            e.onToggled(t, !1);
        },
      });
    },
    $A = (e) => {
      ...
      return ZT.sketch({
        ...
        components: [ZT.parts.groups({})],
        toolbarBehaviours: UA(e, t),
      });
    },
    qA = [
      gv,
    ...
    XA = {
      button: [...qA, nv, as("type", ["button"])],
      togglebutton: [...qA, Cs("active", !1), as("type", ["togglebutton"])],
    },
              ...
              "group" === o.type
                ? ((t = !0),
                  ((e, t) => ({
                    ...
                    components: H(e.buttons, (e) => ZA(e, t)),
                  }))(o, e.providers))
                : ZA(o, e.providers)
            );
            return {
      ...
      pe(t, (t, n) => {
        ...
        return e.slot(
          ...
          oM.sketch({
            ...
            components: [
              ...(s.buttons.length > 0
                ? [oM.parts.header({ buttons: s.buttons, providers: o })]
                : []),
              oM.parts.pane({}),
            ],
          })
  ...
  const lM = GT.optional({
    ...
    dM = GT.optional({
      factory: {
        sketch: (e) => {
          const t = ((e) =>
            e.type === nf.sliding ? GA : e.type === nf.floating ? jA : $A)(e);
          return t({
            type: e.type,
            uid: e.uid,
            onEscape: () => (e.onEscape(), A.some(!0)),
  ...
  var vM = bm({
    ...
    factory: (e, t, o) => {
      ...
      const s = {
        ...
        whichView: (t) =>
          jT.getPart(t, e, "viewWrapper").bind(iM.whichView).getOrNull(),
        hideMainView: (t) => {
  ...
  const yM = {
      ...
      tools: {
        title: "Tools",
        items:
          "spellchecker spellcheckerlanguage | autocorrect capitalization | a11ycheck code typography wordcount addtemplate",
      },
      table: {
        title: "Table",
        items:
      ...
      const o = { ...yM, ...t.menus },
        ...
        s =
          void 0 === t.menubar || !0 === t.menubar
            ? xM("file edit view insert format tools table help")
            : xM(!1 === t.menubar ? "" : t.menubar),
        a = U(s, (e) => {
          const o = ve(yM, e);
    ...
    OM = (e, t) => {
      ...
      return (
        (o = Ve(e.getElement())),
        bt(o).isSome()
          ? kM(e, t + "/skin.shadowdom.min.css", rf.DOM.styleSheetLoader)
          : Promise.resolve()
      );
    },
    _M = (e, t) => {
    ...
    MM = (e, t, o) => {
      const n = o.dataset,
        s =
          "basic" === n.type
            ? () => H(n.data, (e) => bT(e, o.isSelectedFor, o.getPreviewFor))
            : n.getData;
  ...
  const FM = (e, t, o) => {
      const n =
        ((s = ((e, t) =>
          t === BM.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" "))(
          e.options.get(t),
          o
        )),
        H(s, (e) => {
    ...
    RM = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          G(IM, (e) => e.format === t.format).each((t) =>
            e.execCommand(t.command)
          ),
        updateText: (t) => {
          const o = G(IM, (t) => e.formatter.match(t.format)).fold(
            x("left"),
    ...
    WM = (e, t) =>
      A.from(UM.exec(e)).bind((e) => {
        const o = Number(e[1]),
          n = e[2];
        return ((e, t) => N(t, (t) => N(PM[t], (t) => e === t)))(n, t)
          ...
          if (Cf(o) === nf.floating)
            return ((e, t, o, n) => {
              ...
              return EA.sketch({
                ...
                parts: {
                  button: aD(e.icon, e.text, e.tooltip, A.some(i), s.providers),
                  toolbar: {
                    dom: {
                      tag: "div",
                      classes: ["tox-toolbar__overflow"],
              ...
              return Wh.sketch({
                ...
                buttonBehaviours: kl([
                  ...
                  Jp(c, [
                    ...
                    Ty({ getApi: r }, a),
                    Ur(Ys(), (e, t) => {
                      (t.event.raw.keyCode !== jM.space() &&
                        t.event.raw.keyCode !== jM.enter()) ||
                        Rm.isDisabled(e) ||
                        o(!1);
                    }),
                    Ur(er(), u),
          ...
          ((e) => {
            ...
            return {
              ...
              getNewValue: (o, n) => {
                ...
                const s = WM(o, ["unsupportedLength", "empty"]).or(
                    WM(t(), ["unsupportedLength", "empty"])
                  ),
    ...
    render: async (e, t, o, n, s) => {
        ...
        e.addCommand("ToggleView", (t, o) => {
          if (vM.toggleView(l, o)) {
            ...
            r.mothership.broadcastOn([Kd()], { target: t }),
              ...
              c(vM.whichView(l)) &&
                (e.focus(), e.nodeChanged(), vM.refreshToolbar(l));
          }
        }),
      ...
      (g !== nf.sliding && g !== nf.floating) ||
        e.on("ResizeWindow ResizeEditor ResizeContent", () => {
          ...
          o !== i.get() &&
            (vM.refreshToolbar(t.mainUi.outerContainer), i.set(o));
        });
      const p = {
        setEnabled: (e) => {
          yy(t, !e);
      ...
      return {
        ...
        show: () => {
          h.set(!0),
            ...
            w(),
            ib(e)
              ? y((e) => (ME.isDocked(e) ? ME.reset(e) : ME.refresh(e)))
              : y(ME.refresh);
        },
        hide: () => {
          h.set(!1),
  ...
  const AD = "contexttoolbar-hide",
                ...
                Jp("context-toolbar-events", [
                  Kr(or(), (e, t) => {
                    "width" === t.event.raw.propertyName &&
                      (Pa(e.element, GD), Ht(e.element, "width"));
                  }),
                  Ur(jD, (e, t) => {
                    const o = e.element;
                    Ht(o, "width");
                  ...
                  Ur(WD, (e, o) => {
                    ne(t.get()).each((o) => {
                      t.set(t.get().slice(0, t.get().length - 1)),
                        Ir(e, jD, { contents: ai(o.bar), focus: o.focus });
                    });
                  }),
                ]),
                Pp.config({
        ...
        x = (t, n) => {
          ...
          Ht(b, "display"),
            ...
            Ph.showWithinBounds(
              d,
              f(s),
              { anchor: h, transition: { classes: [$D], mode: "placement" } },
              () => A.some(u())
            ),
        ...
        u = () => {
          ...
          ((e, t, o, n, s, r, a) => {
            const i = ((e, t, o) => {
              const n = mB(e, t, o);
              return {
                bubble: gc(0, "point" === o ? 12 : 0, hB),
                layouts: pB,
                overrides: { maxWidthFunction: wA(), maxHeightFunction: cc() },
                ...n,
              };
            })(e, t, r);
            lO(o, gb.CLOSE_ON_EXECUTE, n, {
              ...
              Ph.showMenuWithinBounds(
                ...
                () =>
                  A.some(ID(e, n.shared, "node" === r ? "node" : "selection"))
              ),
                e.dispatch(AD);
            });
          })(e, t, a, n, s, r, !(c || i || (l && d)));
    ...
    kB = (e, t, o) => {
      const n = Do().deviceType.isTouch,
        ...
        i = (t) => {
          if (
            (rB(e) && t.preventDefault(),
            ((e, t) => t.ctrlKey && !rB(e))(e, t) ||
              ((e) => 0 === iB(e).length)(e))
          )
            return;
          const a = ((e, t) => {
    ...
    zB = (e, t, o, n) =>
      re(e, (e) => {
        ...
        return r
          ? A.some({ output: BB(e.output, t, o, n), extra: e.extra })
          : A.none();
      }),
    HB = (e, t, o, n, s) => {
    ...
    snapTo: (e, t, o, n) => {
      ...
      if (t.repositionTarget) {
        const t = et(e.element),
          ...
          r = rE(s),
          a = ((e, t, o) => ({
            coord: BB(e.output, e.output, t, o),
            extra: e.extra,
          }))(n, o, r),
          i = DB(a.coord, 0, r);
        Ft(s, i);
  ...
  const qB = [
    ...
    XB = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) =>
              ("fixed" === o ? RB : FB)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie()
            )
  ...
  const nF = (e, t, o) => {
    ...
    aF = [
      ...qB,
      Ri("dragger", {
        handlers: ZB((e, t, o) => [...eF(e, t, o), ...nF(e, t, o)]),
      }),
    ];
      ...
      e.fold(
        ...
        (e) => {
          ...
          return cF.snap({
            sensor: IB(s, r),
            range: $t(40, 40),
            output: IB(A.some(o - a.width / 2), A.some(n - a.height / 2)),
            extra: { td: t },
          });
        }
      ),
  ...
  const fF = (e, t, o) => {
      ...
      const o = e.inline,
        ...
        b = ((e, t, o) => {
          const n = Es(!1),
            ...
            d = {
              shared: {
                providers: r,
                anchors: aT(t, o, s.isPositionedAtTop),
                header: s,
              },
              urlinput: a,
              styles: i,
        ...
        v = () => {
          const t = (() => {
            ...
            i =
              Pf(e) && !o ? A.some(vF(e, b.popup.shared.providers)) : A.none(),
            l = q([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
            p = vM.parts.editorContainer({
            ...
            a = (() => {
              const t = sb(e),
                ...
                n = {
                  ...
                  behaviours: kl([
                    Sd.config({ useFixed: () => s.isDocked(g) }),
                  ]),
                },
                r = {
            ...
            (v = o.outerContainer),
              ...
              e.addCommand("ToggleToolbarDrawer", (e, t) => {
                (null == t ? void 0 : t.skipFocus)
                  ? vM.toggleToolbarDrawerWithoutFocusing(v)
                  : vM.toggleToolbarDrawer(v);
              }),
              e.addQueryStateHandler("ToggleToolbarDrawer", () =>
                vM.isToolbarDrawerToggled(v)
              ),
              ((e, t, o) => {
                const n = (e, n) => {
                    L([t, ...o], (t) => {
    ...
    ZF = Gn((e) =>
      qn("customeditor.old", Mn(JF), e).orThunk(() =>
        qn("customeditor.new", Mn(YF), e)
      )
    ),
    QF = Hn,
    eI = Dn(zF),
    ...
    aR = (e) => {
      var t;
      return {
        internalDialog: Xn(qn("dialog", QI, e)),
        dataValidator: rR(e),
    ...
    gR = (e, t, o) => {
      ...
      return {
        ...
        behaviours: kl([
          ...
          IC(n, {
            postprocess: (e) => mR(e).fold((e) => (console.error(e), {}), w),
          }),
        ]),
      };
      var s;
        ...
        uR.config({
          ...
          renderComponents: (e) => {
            ...
            return "tabpanel" === t.type
              ? [MR(t, e.initialData, n)]
              : [gR(t, e.initialData, n)];
          },
          initialData: e,
        }),
      ]),
  ...
  var pN = qR([
    ...
    IN = (function e() {
      ...
      var w = (function (e, t) {
          if ("object" !== VR(e) || "function" != typeof e.createPolicy)
            return null;
          var o = null,
      ...
      var D,
        ...
        Se = function (e) {
          (ye && ye === e) ||
            ...
            (ue =
              "ADD_URI_SAFE_ATTR" in e ? uN(mN(me), e.ADD_URI_SAFE_ATTR) : me),
            (ce =
              "ADD_DATA_URI_TAGS" in e ? uN(mN(de), e.ADD_DATA_URI_TAGS) : de),
            ...
            e.FORBID_CONTENTS &&
              (ie === le && (ie = mN(ie)), uN(ie, e.FORBID_CONTENTS)),
            se && (L["#text"] = !0),
        ...
        Ie = function (e) {
          ...
          if (
            ...
            e.hasChildNodes() &&
              ...
              lN(/<[/\w]/g, e.innerHTML) &&
              lN(/<[/\w]/g, e.textContent))
          )
            return Ee(e), !0;
          if ("select" === s && lN(/<template/i, e.innerHTML)) return Ee(e), !0;
          if (!L[s] || G[s]) {
            if (!G[s] && Ne(s)) {
              if (j.tagNameCheck instanceof RegExp && lN(j.tagNameCheck, s))
                return !1;
          ...
          return e instanceof l &&
            ...
            : ("noscript" !== s && "noembed" !== s) ||
              !lN(/<\/no(script|embed)/i, e.innerHTML)
            ? (Y &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = rN(t, F, " ")),
                (t = rN(t, I, " ")),
                e.textContent !== t &&
                  (oN(o.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
        ...
        (o.sanitize = function (e, s) {
          ...
          return (
            J &&
              ...
              lN(BN, a.ownerDocument.doctype.name) &&
  ...
  const RN = (e) => IN().sanitize(e),
    ...
    LN = (e, t) =>
      CF.parts.body({
        ...
        components: [
          {
            dom: { tag: "div", classes: ["tox-dialog__body-content"] },
            components: [{ dom: dA(`<p>${RN(t.translate(e))}</p>`) }],
          },
        ],
      }),
    PN = (e) =>
    ...
    WN = (e) => {
      ...
      return CF.sketch({
        ...
        parts: {
          blocker: {
            dom: dA(`<div class="${o}"></div>`),
            components: [
              { dom: { tag: "div", classes: NN ? [n, n + "--opaque"] : [n] } },
            ],
          },
        },
        dragBlockClass: o,
  ...
  const iV = [
    ...
    cV = (e, t, o, n) => {
      const s = la("dialog"),
        ...
        c = e.buttons.bind((e) =>
          0 === e.length ? A.none() : A.some(nV({ buttons: e }, s, n))
        ),
        u = ((e, t) => {
          const o = (t, o) =>
              Ur(t, (t, s) => {
            ...
            const c = Xn(qn("data", l, i)),
                ...
                const s = la("dialog"),
                  ...
                  g = eV(
                    () => f,
                    {
                      onBlock: (e) => {
                        cA.block(h, (t, n) =>
                          XN(e.message, n, o.shared.providers)
                        );
                      },
                      onUnblock: () => {
                        cA.unblock(h);
              ...
              p = ri(
                Ph.sketch({
                  ...
                  isExtraPart: (e, t) =>
                    ((e) =>
                      jw(e, ".tox-alert-dialog") ||
                      jw(e, ".tox-confirm-dialog"))(t),
                })
              );
            return (
              d.set(p),
