...
!(function () {
  ...
  const n = Array.prototype.push,
    ...
    y = p("media_filter_html"),
    f = p("media_url_resolver"),
        ...
        if (1 === o.type) {
          ...
          r.source || "param" !== e || (r.source = o.attr("movie")),
            ("iframe" !== e &&
              ...
              "video" !== e &&
              "audio" !== e) ||
              (r.type || (r.type = e), (r = k.extend(o.attributes.map, r))),
            "script" === e && (r = { type: "script", source: o.attr("src") }),
            "source" === e &&
              (r.source
  ...
  const M = (e, t = {}) =>
    ...
    G = (e, t) => {
      ...
      if (
        ...
        (k.extend(
          o,
          D(null !== (r = o.embed) && void 0 !== r ? r : "", e.schema)
        ),
        !o.source)
      )
        return "";
      o.altsource || (o.altsource = ""),
        ...
        (o.sourcemime = T(o.source)),
        (o.altsourcemime = T(o.altsource)),
            ...
            ? ((e, t) =>
                t
                  ...
                  : '<audio controls="controls" src="' +
                    ...
                    "</audio>")(o, t)
            : "script" === o.type
            ? ((e) => '<script src="' + e.source + '"></script>')(o)
            : ((e, t) =>
                t
                  ? t(e)
                  : '<video width="' +
      ...
      const r =
        ...
        a = ((e, t, r) => (a) => {
          ...
          return {
            [a]: (a === r
              ? s().bind((e) =>
                  o(e) ? c(e).orThunk(n) : n().orThunk(() => i.from(e))
                )
              : n().orThunk(() => s().bind((e) => (o(e) ? c(e) : i.from(e))))
            ).getOr(""),
          };
        })(e, r, t);
      return {
    ...
    Y = (e, t) => (o) => {
      if (r(o.url) && o.url.trim().length > 0) {
        const r = o.html,
          a = { ...D(r, t.schema), source: o.url, embed: r };
        e.setData(V(a));
      }
    },
    Z = (e, t) => {
